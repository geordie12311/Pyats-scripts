"""Python script to generate OSPF information using restconf"""
...
"""Initialising nornir, disablign warning for url, and 
using getpass to prompt for password"""

nr = InitNornir(config_file="config.yaml")
requests.packages.urllib3.disable_warnings()
# initializing nornir and disabling warnings for url
password = getpass.getpass()
nr.inventory.defaults.password = password
headers = {"Accept": "application/yang-data+json"}


"""Generating files and dictionaries"""
...
"""Generating OSPF data and creating dictionaries"""
...
"""Generating CDP neighor information and collation connection data"""
...
"""Starting the various functions in the script and checking for errors. 
Notifying the user if there were any errors found when script was ran"""
