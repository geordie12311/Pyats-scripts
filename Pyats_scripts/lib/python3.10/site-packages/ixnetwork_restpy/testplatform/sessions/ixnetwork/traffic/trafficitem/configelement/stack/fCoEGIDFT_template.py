...
class FCoEGIDFT(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEGIDFT'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGIDFT.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGIDFT.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGIDFT.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGIDFT.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGIDFT.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGIDFT.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGIDFT.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGIDFT.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGIDFT.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGIDFT.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGIDFT.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGIDFT.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGIDFT.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGIDFT.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGIDFT.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGIDFT.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGIDFT.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGIDFT.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGIDFT.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGIDFT.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGIDFT.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGIDFT.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGIDFT.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGIDFT.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGIDFT.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGIDFT.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGIDFT.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGIDFT.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGIDFT.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGIDFT.header.fcCT.reserved-49',
        'DNSOpcode': 'fCoEGIDFT.header.dNS.opcode-50',
        'DNSMaxsize': 'fCoEGIDFT.header.dNS.maxsize-51',
        'DNSReserved': 'fCoEGIDFT.header.dNS.reserved-52',
        'DNSFlags': 'fCoEGIDFT.header.dNS.flags-53',
        'DNSDomainIdScope': 'fCoEGIDFT.header.dNS.domainIdScope-54',
        'DNSAreaIdScope': 'fCoEGIDFT.header.dNS.areaIdScope-55',
        'DNSFc4TypeCode': 'fCoEGIDFT.header.dNS.fc4TypeCode-56',
        'FcCRCAutoCRC': 'fCoEGIDFT.header.fcCRC.autoCRC-57',
        'FcCRCGenerateBadCRC': 'fCoEGIDFT.header.fcCRC.generateBadCRC-58',
        'FcTrailerEEOF': 'fCoEGIDFT.header.fcTrailer.eEOF-59',
        'FcTrailerReserved': 'fCoEGIDFT.header.fcTrailer.reserved-60',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGIDFT, self).__init__(parent, list_op)
