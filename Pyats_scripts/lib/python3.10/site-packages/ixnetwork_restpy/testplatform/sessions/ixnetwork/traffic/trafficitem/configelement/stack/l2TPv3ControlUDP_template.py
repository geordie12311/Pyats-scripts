...
class L2TPv3ControlUDP(Base):
    ...
    def MessageTypeAvpHidder(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MessageTypeAvpHidder']))
    ...
    def CiscoAvpCiscoAttributeType(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['CiscoAvpCiscoAttributeType']))
    ...
    def HiddenOnLength(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HiddenOnLength']))
