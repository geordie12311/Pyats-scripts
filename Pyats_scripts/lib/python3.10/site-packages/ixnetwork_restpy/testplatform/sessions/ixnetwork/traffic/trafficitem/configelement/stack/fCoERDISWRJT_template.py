...
class FCoERDISWRJT(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoERDISWRJT'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoERDISWRJT.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoERDISWRJT.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoERDISWRJT.header.fcoeHeader.eSOF-3',
        'FcHeaderRCTL': 'fCoERDISWRJT.header.fcHeader.rCTL-4',
        'FcHeaderDstId': 'fCoERDISWRJT.header.fcHeader.dstId-5',
        'FcHeaderCsCTLPriority': 'fCoERDISWRJT.header.fcHeader.csCTLPriority-6',
        'FcHeaderSrcId': 'fCoERDISWRJT.header.fcHeader.srcId-7',
        'FcHeaderType': 'fCoERDISWRJT.header.fcHeader.type-8',
        'FCTLCustom': 'fCoERDISWRJT.header.fcHeader.fCTL.custom-9',
        'BuildFCTLExchangeContext': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.exchangeContext-10',
        'BuildFCTLSequenceContext': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.sequenceContext-11',
        'BuildFCTLFirstSequence': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.firstSequence-12',
        'BuildFCTLLastSequence': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.lastSequence-13',
        'BuildFCTLEndSequence': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.endSequence-14',
        'BuildFCTLEndConnection': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.endConnection-15',
        'BuildFCTLCsCTLPriority': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-16',
        'BuildFCTLSequenceInitiative': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-17',
        'BuildFCTLFcXIDReassigned': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-18',
        'BuildFCTLFcInvalidateXID': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-19',
        'BuildFCTLAckForm': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.ackForm-20',
        'BuildFCTLFcDataCompression': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-21',
        'BuildFCTLFcDataEncryption': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-22',
        'BuildFCTLRetransmittedSequence': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-23',
        'BuildFCTLUnidirectionalTransmit': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-24',
        'BuildFCTLContinueSeqCondition': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-25',
        'BuildFCTLAbortSeqCondition': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-26',
        'BuildFCTLRelativeOffsetPresent': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-27',
        'BuildFCTLExchangeReassembly': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-28',
        'BuildFCTLFillBytes': 'fCoERDISWRJT.header.fcHeader.fCTL.buildFCTL.fillBytes-29',
        'FcHeaderSeqID': 'fCoERDISWRJT.header.fcHeader.seqID-30',
        'FcHeaderDfCTL': 'fCoERDISWRJT.header.fcHeader.dfCTL-31',
        'FcHeaderSeqCNT': 'fCoERDISWRJT.header.fcHeader.seqCNT-32',
        'FcHeaderOxID': 'fCoERDISWRJT.header.fcHeader.oxID-33',
        'FcHeaderRxID': 'fCoERDISWRJT.header.fcHeader.rxID-34',
        'FcHeaderParameter': 'fCoERDISWRJT.header.fcHeader.parameter-35',
        'HeaderFcCmd': 'fCoERDISWRJT.header.fcCmd-36',
        'HeaderReserved1': 'fCoERDISWRJT.header.reserved1-37',
        'HeaderReserved2': 'fCoERDISWRJT.header.reserved2-38',
        'HeaderReasonCode': 'fCoERDISWRJT.header.reasonCode-39',
        'HeaderReasonExplain': 'fCoERDISWRJT.header.reasonExplain-40',
        'HeaderVendor': 'fCoERDISWRJT.header.vendor-41',
    }

    def __init__(self, parent, list_op=False):
        super(FCoERDISWRJT, self).__init__(parent, list_op)
