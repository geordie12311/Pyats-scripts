...
class FCoEGPLML(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEGPLML'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGPLML.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGPLML.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGPLML.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGPLML.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGPLML.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGPLML.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGPLML.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGPLML.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGPLML.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGPLML.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGPLML.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGPLML.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGPLML.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGPLML.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGPLML.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGPLML.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGPLML.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGPLML.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGPLML.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGPLML.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGPLML.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGPLML.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGPLML.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGPLML.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGPLML.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGPLML.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGPLML.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGPLML.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGPLML.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGPLML.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoEGPLML.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoEGPLML.header.FCS.maxsize-51',
        'FCSReserved': 'fCoEGPLML.header.FCS.reserved-52',
        'FCSPlatformName': 'fCoEGPLML.header.FCS.platformName-53',
        'FcCRCAutoCRC': 'fCoEGPLML.header.fcCRC.autoCRC-54',
        'FcCRCGenerateBadCRC': 'fCoEGPLML.header.fcCRC.generateBadCRC-55',
        'FcTrailerEEOF': 'fCoEGPLML.header.fcTrailer.eEOF-56',
        'FcTrailerReserved': 'fCoEGPLML.header.fcTrailer.reserved-57',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGPLML, self).__init__(parent, list_op)
