...
class JpegVideoFormat(Base):
    ...
    def JpegMainHeaderTypeSpecific(self):
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['JpegMainHeaderTypeSpecific']))
    ...
    def JpegMainHeaderFragmentOffset(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['JpegMainHeaderFragmentOffset']))
    ...
    def JpegMainHeaderType(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['JpegMainHeaderType']))
    ...
    def JpegMainHeaderQtable(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['JpegMainHeaderQtable']))
    ...
    def JpegMainHeaderWidth(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['JpegMainHeaderWidth']))
    ...
    def JpegMainHeaderHeight(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['JpegMainHeaderHeight']))
    ...
    def RestartMarkerHeaderRestartInterval(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RestartMarkerHeaderRestartInterval']))
    ...
    def RestartMarkerHeaderFirst(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RestartMarkerHeaderFirst']))
    ...
    def RestartMarkerHeaderLast(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RestartMarkerHeaderLast']))
    ...
    def RestartMarkerHeaderRestartCount(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RestartMarkerHeaderRestartCount']))
    ...
    def QuantizationTableHeaderMbz(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['QuantizationTableHeaderMbz']))
    ...
    def QuantizationTableHeaderPrecision(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['QuantizationTableHeaderPrecision']))
    ...
    def QuantizationTableHeaderLength(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['QuantizationTableHeaderLength']))
    ...
    def QuantizationTableHeaderData(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['QuantizationTableHeaderData']))
