...
class FCoERCSID(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoERCSID'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoERCSID.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoERCSID.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoERCSID.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoERCSID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoERCSID.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoERCSID.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoERCSID.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoERCSID.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoERCSID.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoERCSID.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoERCSID.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoERCSID.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoERCSID.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoERCSID.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoERCSID.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoERCSID.header.fcHeader.type-16',
        'FCTLCustom': 'fCoERCSID.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoERCSID.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoERCSID.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoERCSID.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoERCSID.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoERCSID.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoERCSID.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoERCSID.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoERCSID.header.fcCT.revision-44',
        'FcCTInId': 'fCoERCSID.header.fcCT.inId-45',
        'FcCTGsType': 'fCoERCSID.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoERCSID.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoERCSID.header.fcCT.options-48',
        'FcCTReserved': 'fCoERCSID.header.fcCT.reserved-49',
        'DNSOpcode': 'fCoERCSID.header.dNS.opcode-50',
        'DNSMaxsize': 'fCoERCSID.header.dNS.maxsize-51',
        'DNSReserved': 'fCoERCSID.header.dNS.reserved-52',
        'DNSPortId': 'fCoERCSID.header.dNS.portId-53',
        'DNSClassOfService': 'fCoERCSID.header.dNS.classOfService-54',
        'FcCRCAutoCRC': 'fCoERCSID.header.fcCRC.autoCRC-55',
        'FcCRCGenerateBadCRC': 'fCoERCSID.header.fcCRC.generateBadCRC-56',
        'FcTrailerEEOF': 'fCoERCSID.header.fcTrailer.eEOF-57',
        'FcTrailerReserved': 'fCoERCSID.header.fcTrailer.reserved-58',
    }

    def __init__(self, parent, list_op=False):
        super(FCoERCSID, self).__init__(parent, list_op)
