...
class Mldv2Report(Base):
    ...
    def Mldv2ListenerReportType(self):
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Mldv2ListenerReportType']))
    ...
    def Mldv2ListenerReportReserved(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Mldv2ListenerReportReserved']))
    ...
    def Mldv2ListenerReportMldv2Checksum(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Mldv2ListenerReportMldv2Checksum']))
    ...
    def Mldv2ListenerReportNrOfMcastAddresses(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Mldv2ListenerReportNrOfMcastAddresses']))
    ...
    def Mldv2AddressRecordRecordType(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Mldv2AddressRecordRecordType']))
    ...
    def Mldv2AddressRecordAuxDataLen(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Mldv2AddressRecordAuxDataLen']))
    ...
    def Mldv2AddressRecordNrOfSourceAddresses(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Mldv2AddressRecordNrOfSourceAddresses']))
    ...
    def Mldv2AddressRecordMulticastAddress(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Mldv2AddressRecordMulticastAddress']))
    ...
    def SourceAddressRecordSourceAddress(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['SourceAddressRecordSourceAddress']))
