...
class FCoEGNID(Base):
    ...
    _SDM_NAME = 'fCoEGNID'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGNID.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGNID.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGNID.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGNID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGNID.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGNID.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGNID.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGNID.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGNID.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGNID.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGNID.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGNID.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGNID.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGNID.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGNID.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGNID.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGNID.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGNID.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGNID.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGNID.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGNID.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGNID.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGNID.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGNID.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGNID.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGNID.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGNID.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGNID.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGNID.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGNID.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoEGNID.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoEGNID.header.FCS.maxsize-51',
        'FCSReserved': 'fCoEGNID.header.FCS.reserved-52',
        'FCSPlatformNodeName': 'fCoEGNID.header.FCS.platformNodeName-53',
        'FCSNodeIdentificationDataFormat': 'fCoEGNID.header.FCS.nodeIdentificationDataFormat-54',
        'FCSReserved2': 'fCoEGNID.header.FCS.reserved2-55',
        'FcCRCAutoCRC': 'fCoEGNID.header.fcCRC.autoCRC-56',
        'FcCRCGenerateBadCRC': 'fCoEGNID.header.fcCRC.generateBadCRC-57',
        'FcTrailerEEOF': 'fCoEGNID.header.fcTrailer.eEOF-58',
        'FcTrailerReserved': 'fCoEGNID.header.fcTrailer.reserved-59',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGNID, self).__init__(parent, list_op)
