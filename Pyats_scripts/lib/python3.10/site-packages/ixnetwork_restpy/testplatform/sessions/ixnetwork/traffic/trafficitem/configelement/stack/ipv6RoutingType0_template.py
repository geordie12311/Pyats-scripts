...
class Ipv6RoutingType0(Base):
    __slots__ = ()
    _SDM_NAME = 'ipv6RoutingType0'
    _SDM_ATT_MAP = {
        'RoutingHeaderType0NextHeader': 'ipv6RoutingType0.routingHeaderType0.nextHeader-1',
        'RoutingHeaderType0HeaderExtensionLength': 'ipv6RoutingType0.routingHeaderType0.headerExtensionLength-2',
        'RoutingHeaderType0RoutingType': 'ipv6RoutingType0.routingHeaderType0.routingType-3',
        'RoutingHeaderType0SegmentsLeft': 'ipv6RoutingType0.routingHeaderType0.segmentsLeft-4',
        'RoutingHeaderType0Reserved': 'ipv6RoutingType0.routingHeaderType0.reserved-5',
        'AddressesAddress': 'ipv6RoutingType0.routingHeaderType0.addresses.address-6',
    }

    def __init__(self, parent, list_op=False):
        super(Ipv6RoutingType0, self).__init__(parent, list_op)

    @property
    def RoutingHeaderType0NextHeader(self):
        """
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderType0NextHeader']))

    @property
    def RoutingHeaderType0HeaderExtensionLength(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderType0HeaderExtensionLength']))

    @property
    def RoutingHeaderType0RoutingType(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderType0RoutingType']))

    @property
    def RoutingHeaderType0SegmentsLeft(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderType0SegmentsLeft']))

    @property
    def RoutingHeaderType0Reserved(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderType0Reserved']))
