...
class FCoEGPLT(Base):
    ...
    _SDM_NAME = 'fCoEGPLT'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGPLT.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGPLT.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGPLT.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGPLT.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGPLT.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGPLT.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGPLT.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGPLT.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGPLT.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGPLT.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGPLT.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGPLT.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGPLT.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGPLT.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGPLT.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGPLT.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGPLT.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGPLT.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGPLT.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGPLT.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGPLT.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGPLT.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGPLT.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGPLT.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGPLT.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGPLT.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGPLT.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGPLT.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGPLT.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGPLT.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoEGPLT.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoEGPLT.header.FCS.maxsize-51',
        'FCSReserved': 'fCoEGPLT.header.FCS.reserved-52',
        'FCSPlatformName': 'fCoEGPLT.header.FCS.platformName-53',
        'FcCRCAutoCRC': 'fCoEGPLT.header.fcCRC.autoCRC-54',
        'FcCRCGenerateBadCRC': 'fCoEGPLT.header.fcCRC.generateBadCRC-55',
        'FcTrailerEEOF': 'fCoEGPLT.header.fcTrailer.eEOF-56',
        'FcTrailerReserved': 'fCoEGPLT.header.fcTrailer.reserved-57',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGPLT, self).__init__(parent, list_op)
