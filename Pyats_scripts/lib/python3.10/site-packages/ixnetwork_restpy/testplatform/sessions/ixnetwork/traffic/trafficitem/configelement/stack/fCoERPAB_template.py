...
class FCoERPAB(Base):
    ...
    _SDM_NAME = 'fCoERPAB'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoERPAB.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoERPAB.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoERPAB.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoERPAB.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoERPAB.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoERPAB.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoERPAB.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoERPAB.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoERPAB.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoERPAB.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoERPAB.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoERPAB.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoERPAB.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoERPAB.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoERPAB.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoERPAB.header.fcHeader.type-16',
        'FCTLCustom': 'fCoERPAB.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoERPAB.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoERPAB.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoERPAB.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoERPAB.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoERPAB.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoERPAB.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoERPAB.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoERPAB.header.fcCT.revision-44',
        'FcCTInId': 'fCoERPAB.header.fcCT.inId-45',
        'FcCTGsType': 'fCoERPAB.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoERPAB.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoERPAB.header.fcCT.options-48',
        'FcCTReserved': 'fCoERPAB.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoERPAB.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoERPAB.header.FCS.maxsize-51',
        'FCSReserved': 'fCoERPAB.header.FCS.reserved-52',
        'FCSPlatformName': 'fCoERPAB.header.FCS.platformName-53',
        'FCSPlatformAttributeBlock': 'fCoERPAB.header.FCS.platformAttributeBlock-54',
        'FcCRCAutoCRC': 'fCoERPAB.header.fcCRC.autoCRC-55',
        'FcCRCGenerateBadCRC': 'fCoERPAB.header.fcCRC.generateBadCRC-56',
        'FcTrailerEEOF': 'fCoERPAB.header.fcTrailer.eEOF-57',
        'FcTrailerReserved': 'fCoERPAB.header.fcTrailer.reserved-58',
    }

    def __init__(self, parent, list_op=False):
        super(FCoERPAB, self).__init__(parent, list_op)
