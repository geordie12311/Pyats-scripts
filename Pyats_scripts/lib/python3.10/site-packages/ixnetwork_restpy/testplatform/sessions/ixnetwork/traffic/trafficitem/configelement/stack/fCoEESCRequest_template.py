...
class FCoEESCRequest(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEESCRequest'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEESCRequest.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEESCRequest.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEESCRequest.header.fcoeHeader.eSOF-3',
        'FcHeaderRCTL': 'fCoEESCRequest.header.fcHeader.rCTL-4',
        'FcHeaderDstId': 'fCoEESCRequest.header.fcHeader.dstId-5',
        'FcHeaderCsCTLPriority': 'fCoEESCRequest.header.fcHeader.csCTLPriority-6',
        'FcHeaderSrcId': 'fCoEESCRequest.header.fcHeader.srcId-7',
        'FcHeaderType': 'fCoEESCRequest.header.fcHeader.type-8',
        'FCTLCustom': 'fCoEESCRequest.header.fcHeader.fCTL.custom-9',
        'BuildFCTLExchangeContext': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.exchangeContext-10',
        'BuildFCTLSequenceContext': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.sequenceContext-11',
        'BuildFCTLFirstSequence': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.firstSequence-12',
        'BuildFCTLLastSequence': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.lastSequence-13',
        'BuildFCTLEndSequence': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.endSequence-14',
        'BuildFCTLEndConnection': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.endConnection-15',
        'BuildFCTLCsCTLPriority': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.csCTLPriority-16',
        'BuildFCTLSequenceInitiative': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-17',
        'BuildFCTLFcXIDReassigned': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-18',
        'BuildFCTLFcInvalidateXID': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-19',
        'BuildFCTLAckForm': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.ackForm-20',
        'BuildFCTLFcDataCompression': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.fcDataCompression-21',
        'BuildFCTLFcDataEncryption': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-22',
        'BuildFCTLRetransmittedSequence': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-23',
        'BuildFCTLUnidirectionalTransmit': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-24',
        'BuildFCTLContinueSeqCondition': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-25',
        'BuildFCTLAbortSeqCondition': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-26',
        'BuildFCTLRelativeOffsetPresent': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-27',
        'BuildFCTLExchangeReassembly': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-28',
        'BuildFCTLFillBytes': 'fCoEESCRequest.header.fcHeader.fCTL.buildFCTL.fillBytes-29',
        'FcHeaderSeqID': 'fCoEESCRequest.header.fcHeader.seqID-30',
        'FcHeaderDfCTL': 'fCoEESCRequest.header.fcHeader.dfCTL-31',
        'FcHeaderSeqCNT': 'fCoEESCRequest.header.fcHeader.seqCNT-32',
        'FcHeaderOxID': 'fCoEESCRequest.header.fcHeader.oxID-33',
        'FcHeaderRxID': 'fCoEESCRequest.header.fcHeader.rxID-34',
        'FcHeaderParameter': 'fCoEESCRequest.header.fcHeader.parameter-35',
        'HeaderFcCmd': 'fCoEESCRequest.header.fcCmd-36',
        'HeaderReserved1': 'fCoEESCRequest.header.reserved1-37',
        'HeaderFlags': 'fCoEESCRequest.header.flags-38',
        'HeaderLength': 'fCoEESCRequest.header.length-39',
        'HeaderVendorId': 'fCoEESCRequest.header.vendorId-40',
        'HeaderProtocolDescriptor': 'fCoEESCRequest.header.protocolDescriptor-41',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEESCRequest, self).__init__(parent, list_op)
