...
class Avtpdu(Base):
    ...
    def AvtpduCommonStreamHeaderSubtype(self):
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvtpduCommonStreamHeaderSubtype']))
    ...
    def AvtpduCommonStreamHeaderStreamIdValid(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvtpduCommonStreamHeaderStreamIdValid']))
    ...
    def AvtpduCommonStreamHeaderVersion(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvtpduCommonStreamHeaderVersion']))
    ...
    def AvtpduTypeSpecificHeaderMediaClockRestart(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvtpduTypeSpecificHeaderMediaClockRestart']))
    ...
    def AvtpduTypeSpecificHeaderRsv(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvtpduTypeSpecificHeaderRsv']))
    ...
    def AvtpduTypeSpecificHeaderAvtpTimeStampValid(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvtpduTypeSpecificHeaderAvtpTimeStampValid']))
    ...
    def AvtpduTypeSpecificHeaderSequenceNumber(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvtpduTypeSpecificHeaderSequenceNumber']))
    ...
    def AvtpduTypeSpecificHeaderReservedField(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvtpduTypeSpecificHeaderReservedField']))
    ...
    def AvtpduTypeSpecificHeaderTimeStampUncertain(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvtpduTypeSpecificHeaderTimeStampUncertain']))
    ...
    def AvtpduStreamIdStreamId(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvtpduStreamIdStreamId']))
    ...
    def AvtpduStreamIdAvtpTimestamp(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvtpduStreamIdAvtpTimestamp']))
    ...
    def FormatInformationFormat(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FormatInformationFormat']))
    ...
    def FormatInformationFormatSubtype(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FormatInformationFormatSubtype']))
    ...
    def FormatInformationReservedField3(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FormatInformationReservedField3']))
    ...
    def SdiSpecificInformationFormat(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['SdiSpecificInformationFormat']))
    ...
    def SdiSpecificInformationISequenceNumber(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['SdiSpecificInformationISequenceNumber']))
    ...
    def SdiSpecificInformationPacketInformation(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['SdiSpecificInformationPacketInformation']))
    ...
    def PacketInformationStreamdataLength(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['PacketInformationStreamdataLength']))
    ...
    def TypeIIReservedField5(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['TypeIIReservedField5']))
    ...
    def TypeIIGuardBand(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['TypeIIGuardBand']))
    ...
    def TypeIIRp168Switch(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['TypeIIRp168Switch']))
    ...
    def TypeIIEndFrame(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['TypeIIEndFrame']))
    ...
    def ProtocolSpecificHeaderEVT(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ProtocolSpecificHeaderEVT']))
    ...
    def ProtocolSpecificHeaderReservedField4(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ProtocolSpecificHeaderReservedField4']))
