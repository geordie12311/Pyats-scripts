...
class Ipv6(Base):
    ...
    _SDM_NAME = 'ipv6'
    _SDM_ATT_MAP = {
        'VersionTrafficClassFlowLabelVersion': 'ipv6.header.versionTrafficClassFlowLabel.version-1',
        'VersionTrafficClassFlowLabelTrafficClass': 'ipv6.header.versionTrafficClassFlowLabel.trafficClass-2',
        'VersionTrafficClassFlowLabelFlowLabel': 'ipv6.header.versionTrafficClassFlowLabel.flowLabel-3',
        'PayloadLength': 'ipv6.header.payloadLength-4',
        'NextHeader': 'ipv6.header.nextHeader-5',
        'HopLimit': 'ipv6.header.hopLimit-6',
        'SrcIP': 'ipv6.header.srcIP-7',
        'DstIP': 'ipv6.header.dstIP-8',
    }
