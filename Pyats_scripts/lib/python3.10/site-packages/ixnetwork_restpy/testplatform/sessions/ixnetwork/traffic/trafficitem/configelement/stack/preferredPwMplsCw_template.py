...
class PreferredPwMplsCw(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(PreferredPwMplsCw, self).__init__(parent, list_op)
    ...
    def ControlWordFrg(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlWordFrg']))
