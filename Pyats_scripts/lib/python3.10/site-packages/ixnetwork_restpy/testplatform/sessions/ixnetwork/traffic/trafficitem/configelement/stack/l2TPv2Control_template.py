...
class L2TPv2Control(Base):
    ...
    def ControlHeaderControlTBit(self):
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderControlTBit']))
    ...
    def ControlHeaderControlLBit(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderControlLBit']))
    ...
    def ControlHeaderXBit(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderXBit']))
    ...
    def ControlHeaderX1Bit(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderX1Bit']))
    ...
    def ControlHeaderControlSBit(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderControlSBit']))
    ...
    def ControlHeaderControlFlags(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderControlFlags']))
    ...
    def ControlHeaderVer(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderVer']))
    ...
    def ControlHeaderControlLength(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderControlLength']))
    ...
    def ControlHeaderTunnelId(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderTunnelId']))
    ...
    def ControlHeaderSessionId(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderSessionId']))
    ...
    def ControlHeaderNs(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderNs']))
    ...
    def ControlHeaderNr(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ControlHeaderNr']))
    ...
    def MessageTypeAvpMBit(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MessageTypeAvpMBit']))
    ...
    def MessageTypeAvpHBit(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MessageTypeAvpHBit']))
    ...
    def MessageTypeAvpRsvd4(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MessageTypeAvpRsvd4']))
    ...
    def MessageTypeAvpMtLength(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MessageTypeAvpMtLength']))
    ...
    def MessageTypeAvpMtVendorId(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MessageTypeAvpMtVendorId']))
    ...
    def MessageTypeAvpMtAttribute(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MessageTypeAvpMtAttribute']))
    ...
    def MessageTypeAvpMessageType(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MessageTypeAvpMessageType']))
    ...
    def AvpAttributeType(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AvpAttributeType']))
    ...
    def HBitIsOffLength1(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HBitIsOffLength1']))
    ...
    def HBitIsOffData1(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HBitIsOffData1']))
    ...
    def HBitIsOnLength2(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HBitIsOnLength2']))
    ...
    def PaddingPadLength(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['PaddingPadLength']))
