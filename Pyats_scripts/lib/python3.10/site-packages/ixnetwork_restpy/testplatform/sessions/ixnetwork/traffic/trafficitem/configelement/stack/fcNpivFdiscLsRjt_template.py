...
class FcNpivFdiscLsRjt(Base):
    __slots__ = ()
    _SDM_NAME = 'fcNpivFdiscLsRjt'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fcNpivFdiscLsRjt.header.fcHeader.sof-1',
        'ExtendedLinkServicesExtendedLinkServiceInfo': 'fcNpivFdiscLsRjt.header.fcHeader.RCtl.extendedLinkServices.extendedLinkServiceInfo-2',
        'FcHeaderDId': 'fcNpivFdiscLsRjt.header.fcHeader.DId-3',
        'FcHeaderCsCtlPriority': 'fcNpivFdiscLsRjt.header.fcHeader.CsCtlPriority-4',
        'FcHeaderSId': 'fcNpivFdiscLsRjt.header.fcHeader.SId-5',
        'FcHeaderType': 'fcNpivFdiscLsRjt.header.fcHeader.Type-6',
        'FCtlExchangeContext': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.exchangeContext-7',
        'FCtlSequenceContext': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.sequenceContext-8',
        'FCtlFirstSequence': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.firstSequence-9',
        'FCtlLastSequence': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.lastSequence-10',
        'FCtlEndSequence': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.endSequence-11',
        'FCtlEndConnection': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.endConnection-12',
        'FCtlCsCtlPriority': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.csCtlPriority-13',
        'FCtlSequenceInitiative': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.sequenceInitiative-14',
        'FCtlFcXidReassigned': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.fcXidReassigned-15',
        'FCtlFcInvalidateXid': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.fcInvalidateXid-16',
        'FCtlAckForm': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.ackForm-17',
        'FCtlFcDataCompression': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.fcDataCompression-18',
        'FCtlFcDataEncryption': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.fcDataEncryption-19',
        'FCtlRetransmittedSequence': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.retransmittedSequence-20',
        'FCtlUnidirectionalTransmit': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.unidirectionalTransmit-21',
        'FCtlContinueSeqCondition': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.continueSeqCondition-22',
        'FCtlAbortSeqCondition': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.abortSeqCondition-23',
        'FCtlRelativeOffsetPresent': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.relativeOffsetPresent-24',
        'FCtlExchangeReassembly': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.exchangeReassembly-25',
        'FCtlFillBytes': 'fcNpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.fillBytes-26',
        'FcHeaderSeqId': 'fcNpivFdiscLsRjt.header.fcHeader.SeqId-27',
        'FcHeaderDfCtl': 'fcNpivFdiscLsRjt.header.fcHeader.DfCtl-28',
        'FcHeaderSeqCnt': 'fcNpivFdiscLsRjt.header.fcHeader.SeqCnt-29',
        'FcHeaderOxId': 'fcNpivFdiscLsRjt.header.fcHeader.OxId-30',
        'FcHeaderRxId': 'fcNpivFdiscLsRjt.header.fcHeader.RxId-31',
        'FcHeaderParameter': 'fcNpivFdiscLsRjt.header.fcHeader.Parameter-32',
        'FcElsCommandCodeFcElsCommandCodeLsRjt': 'fcNpivFdiscLsRjt.header.FcEls.FcElsAcceptReject.FcElsCommandCode.FcElsCommandCodeLsRjt-33',
        'FcElsAcceptRejectFcElsAcceptRejectReserved': 'fcNpivFdiscLsRjt.header.FcEls.FcElsAcceptReject.FcElsAcceptRejectReserved-34',
        'FcElsAcceptRejectFcElsLsRjtReasonCodes': 'fcNpivFdiscLsRjt.header.FcEls.FcElsAcceptReject.FcElsLsRjtReasonCodes-35',
    }

    def __init__(self, parent, list_op=False):
        super(FcNpivFdiscLsRjt, self).__init__(parent, list_op)
