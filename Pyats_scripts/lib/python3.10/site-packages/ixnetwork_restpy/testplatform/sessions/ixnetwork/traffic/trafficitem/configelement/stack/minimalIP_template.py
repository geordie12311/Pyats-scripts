...
class MinimalIP(Base):
    __slots__ = ()
    _SDM_NAME = 'minimalIP'
    _SDM_ATT_MAP = {
        'MinimalEncapsulationHeaderProtocol': 'minimalIP.minimalEncapsulationHeader.protocol-1',
        'MinimalEncapsulationHeaderSBit': 'minimalIP.minimalEncapsulationHeader.sBit-2',
        'MinimalEncapsulationHeaderReserved': 'minimalIP.minimalEncapsulationHeader.reserved-3',
        'MinimalEncapsulationHeaderChecksum': 'minimalIP.minimalEncapsulationHeader.checksum-4',
        'MinimalEncapsulationHeaderOriginalDestinationAddress': 'minimalIP.minimalEncapsulationHeader.originalDestinationAddress-5',
        'WithSourceOriginalSourceAddress': 'minimalIP.minimalEncapsulationHeader.sourceOption.withSource.originalSourceAddress-6',
        'SourceOptionNoSource': 'minimalIP.minimalEncapsulationHeader.sourceOption.noSource-7',
    }

    def __init__(self, parent, list_op=False):
        super(MinimalIP, self).__init__(parent, list_op)

    @property
    def MinimalEncapsulationHeaderProtocol(self):
        """
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MinimalEncapsulationHeaderProtocol']))

    @property
    def MinimalEncapsulationHeaderSBit(self):
        """
        Display Name: S bit
        Default Value: 0
        Value Format: decimal
        Available enum values: Src. Addr. Not Present, 0, Src. Addr. Present, 1
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MinimalEncapsulationHeaderSBit']))

    @property
    def MinimalEncapsulationHeaderReserved(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MinimalEncapsulationHeaderReserved']))

    @property
    def MinimalEncapsulationHeaderChecksum(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MinimalEncapsulationHeaderChecksum']))

    @property
    def MinimalEncapsulationHeaderOriginalDestinationAddress(self):
        """
        Display Name: Original Destination Address
        Default Value: 0.0.0.0
        Value Format: iPv4
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MinimalEncapsulationHeaderOriginalDestinationAddress']))

    @property
    def WithSourceOriginalSourceAddress(self):
        """
        Display Name: Original Source Address
        Default Value: 0.0.0.0
        Value Format: iPv4
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['WithSourceOriginalSourceAddress']))

    @property
    def SourceOptionNoSource(self):
        """
        Display Name: No Source
        Default Value: 0
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['SourceOptionNoSource']))
