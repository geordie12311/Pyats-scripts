...
class FCoERDISWACC(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoERDISWACC'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoERDISWACC.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoERDISWACC.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoERDISWACC.header.fcoeHeader.eSOF-3',
        'FcHeaderRCTL': 'fCoERDISWACC.header.fcHeader.rCTL-4',
        'FcHeaderDstId': 'fCoERDISWACC.header.fcHeader.dstId-5',
        'FcHeaderCsCTLPriority': 'fCoERDISWACC.header.fcHeader.csCTLPriority-6',
        'FcHeaderSrcId': 'fCoERDISWACC.header.fcHeader.srcId-7',
        'FcHeaderType': 'fCoERDISWACC.header.fcHeader.type-8',
        'FCTLCustom': 'fCoERDISWACC.header.fcHeader.fCTL.custom-9',
        'BuildFCTLExchangeContext': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.exchangeContext-10',
        'BuildFCTLSequenceContext': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.sequenceContext-11',
        'BuildFCTLFirstSequence': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.firstSequence-12',
        'BuildFCTLLastSequence': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.lastSequence-13',
        'BuildFCTLEndSequence': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.endSequence-14',
        'BuildFCTLEndConnection': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.endConnection-15',
        'BuildFCTLCsCTLPriority': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.csCTLPriority-16',
        'BuildFCTLSequenceInitiative': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-17',
        'BuildFCTLFcXIDReassigned': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-18',
        'BuildFCTLFcInvalidateXID': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-19',
        'BuildFCTLAckForm': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.ackForm-20',
        'BuildFCTLFcDataCompression': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.fcDataCompression-21',
        'BuildFCTLFcDataEncryption': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-22',
        'BuildFCTLRetransmittedSequence': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-23',
        'BuildFCTLUnidirectionalTransmit': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-24',
        'BuildFCTLContinueSeqCondition': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-25',
        'BuildFCTLAbortSeqCondition': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-26',
        'BuildFCTLRelativeOffsetPresent': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-27',
        'BuildFCTLExchangeReassembly': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-28',
        'BuildFCTLFillBytes': 'fCoERDISWACC.header.fcHeader.fCTL.buildFCTL.fillBytes-29',
        'FcHeaderSeqID': 'fCoERDISWACC.header.fcHeader.seqID-30',
        'FcHeaderDfCTL': 'fCoERDISWACC.header.fcHeader.dfCTL-31',
        'FcHeaderSeqCNT': 'fCoERDISWACC.header.fcHeader.seqCNT-32',
        'FcHeaderOxID': 'fCoERDISWACC.header.fcHeader.oxID-33',
        'FcHeaderRxID': 'fCoERDISWACC.header.fcHeader.rxID-34',
        'FcHeaderParameter': 'fCoERDISWACC.header.fcHeader.parameter-35',
        'HeaderFcCmd': 'fCoERDISWACC.header.fcCmd-36',
        'HeaderReserved1': 'fCoERDISWACC.header.reserved1-37',
        'HeaderReserved2': 'fCoERDISWACC.header.reserved2-38',
        'HeaderLength': 'fCoERDISWACC.header.length-39',
        'HeaderReserved3': 'fCoERDISWACC.header.reserved3-40',
        'HeaderGrantedDID': 'fCoERDISWACC.header.grantedDID-41',
    }

    def __init__(self, parent, list_op=False):
        super(FCoERDISWACC, self).__init__(parent, list_op)
