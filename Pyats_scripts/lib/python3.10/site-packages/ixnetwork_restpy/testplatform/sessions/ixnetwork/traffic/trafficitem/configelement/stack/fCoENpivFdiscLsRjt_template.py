...
class FCoENpivFdiscLsRjt(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoENpivFdiscLsRjt'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoENpivFdiscLsRjt.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoENpivFdiscLsRjt.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoENpivFdiscLsRjt.header.fcoeHeader.eSOF-3',
        'ExtendedLinkServicesExtendedLinkServiceInfo': 'fCoENpivFdiscLsRjt.header.fcHeader.RCtl.extendedLinkServices.extendedLinkServiceInfo-4',
        'FcHeaderDId': 'fCoENpivFdiscLsRjt.header.fcHeader.DId-5',
        'FcHeaderCsCtlPriority': 'fCoENpivFdiscLsRjt.header.fcHeader.CsCtlPriority-6',
        'FcHeaderSId': 'fCoENpivFdiscLsRjt.header.fcHeader.SId-7',
        'FcHeaderType': 'fCoENpivFdiscLsRjt.header.fcHeader.Type-8',
        'FCtlExchangeContext': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.exchangeContext-9',
        'FCtlSequenceContext': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.sequenceContext-10',
        'FCtlFirstSequence': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.firstSequence-11',
        'FCtlLastSequence': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.lastSequence-12',
        'FCtlEndSequence': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.endSequence-13',
        'FCtlEndConnection': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.endConnection-14',
        'FCtlCsCtlPriority': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.csCtlPriority-15',
        'FCtlSequenceInitiative': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.sequenceInitiative-16',
        'FCtlFcXidReassigned': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.fcXidReassigned-17',
        'FCtlFcInvalidateXid': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.fcInvalidateXid-18',
        'FCtlAckForm': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.ackForm-19',
        'FCtlFcDataCompression': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.fcDataCompression-20',
        'FCtlFcDataEncryption': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.fcDataEncryption-21',
        'FCtlRetransmittedSequence': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.retransmittedSequence-22',
        'FCtlUnidirectionalTransmit': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.unidirectionalTransmit-23',
        'FCtlContinueSeqCondition': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.continueSeqCondition-24',
        'FCtlAbortSeqCondition': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.abortSeqCondition-25',
        'FCtlRelativeOffsetPresent': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.relativeOffsetPresent-26',
        'FCtlExchangeReassembly': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.exchangeReassembly-27',
        'FCtlFillBytes': 'fCoENpivFdiscLsRjt.header.fcHeader.FCtl.fCtl.fillBytes-28',
        'FcHeaderSeqId': 'fCoENpivFdiscLsRjt.header.fcHeader.SeqId-29',
        'FcHeaderDfCtl': 'fCoENpivFdiscLsRjt.header.fcHeader.DfCtl-30',
        'FcHeaderSeqCnt': 'fCoENpivFdiscLsRjt.header.fcHeader.SeqCnt-31',
        'FcHeaderOxId': 'fCoENpivFdiscLsRjt.header.fcHeader.OxId-32',
        'FcHeaderRxId': 'fCoENpivFdiscLsRjt.header.fcHeader.RxId-33',
        'FcHeaderParameter': 'fCoENpivFdiscLsRjt.header.fcHeader.Parameter-34',
        'FcElsCommandCodeFcElsCommandCodeLsRjt': 'fCoENpivFdiscLsRjt.header.FcEls.FcElsAcceptReject.FcElsCommandCode.FcElsCommandCodeLsRjt-35',
        'FcElsAcceptRejectFcElsAcceptRejectReserved': 'fCoENpivFdiscLsRjt.header.FcEls.FcElsAcceptReject.FcElsAcceptRejectReserved-36',
        'FcElsAcceptRejectFcElsLsRjtReasonCodes': 'fCoENpivFdiscLsRjt.header.FcEls.FcElsAcceptReject.FcElsLsRjtReasonCodes-37',
    }

    def __init__(self, parent, list_op=False):
        super(FCoENpivFdiscLsRjt, self).__init__(parent, list_op)
