...
class FcNpivFdicsLsAcc(Base):
    __slots__ = ()
    _SDM_NAME = 'fcNpivFdicsLsAcc'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fcNpivFdicsLsAcc.header.fcHeader.sof-1',
        'ExtendedLinkServicesExtendedLinkServiceInfo': 'fcNpivFdicsLsAcc.header.fcHeader.RCtl.extendedLinkServices.extendedLinkServiceInfo-2',
        'FcHeaderDId': 'fcNpivFdicsLsAcc.header.fcHeader.DId-3',
        'FcHeaderCsCtlPriority': 'fcNpivFdicsLsAcc.header.fcHeader.CsCtlPriority-4',
        'FcHeaderSId': 'fcNpivFdicsLsAcc.header.fcHeader.SId-5',
        'FcHeaderType': 'fcNpivFdicsLsAcc.header.fcHeader.Type-6',
        'FCtlExchangeContext': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.exchangeContext-7',
        'FCtlSequenceContext': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.sequenceContext-8',
        'FCtlFirstSequence': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.firstSequence-9',
        'FCtlLastSequence': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.lastSequence-10',
        'FCtlEndSequence': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.endSequence-11',
        'FCtlEndConnection': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.endConnection-12',
        'FCtlCsCtlPriority': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.csCtlPriority-13',
        'FCtlSequenceInitiative': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.sequenceInitiative-14',
        'FCtlFcXidReassigned': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.fcXidReassigned-15',
        'FCtlFcInvalidateXid': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.fcInvalidateXid-16',
        'FCtlAckForm': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.ackForm-17',
        'FCtlFcDataCompression': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.fcDataCompression-18',
        'FCtlFcDataEncryption': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.fcDataEncryption-19',
        'FCtlRetransmittedSequence': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.retransmittedSequence-20',
        'FCtlUnidirectionalTransmit': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.unidirectionalTransmit-21',
        'FCtlContinueSeqCondition': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.continueSeqCondition-22',
        'FCtlAbortSeqCondition': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.abortSeqCondition-23',
        'FCtlRelativeOffsetPresent': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.relativeOffsetPresent-24',
        'FCtlExchangeReassembly': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.exchangeReassembly-25',
        'FCtlFillBytes': 'fcNpivFdicsLsAcc.header.fcHeader.FCtl.fCtl.fillBytes-26',
        'FcHeaderSeqId': 'fcNpivFdicsLsAcc.header.fcHeader.SeqId-27',
        'FcHeaderDfCtl': 'fcNpivFdicsLsAcc.header.fcHeader.DfCtl-28',
        'FcHeaderSeqCnt': 'fcNpivFdicsLsAcc.header.fcHeader.SeqCnt-29',
        'FcHeaderOxId': 'fcNpivFdicsLsAcc.header.fcHeader.OxId-30',
        'FcHeaderRxId': 'fcNpivFdicsLsAcc.header.fcHeader.RxId-31',
        'FcHeaderParameter': 'fcNpivFdicsLsAcc.header.fcHeader.Parameter-32',
        'FcElsCommandCodeFcElsCommandCodeLsAcc': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsCommandCode.FcElsCommandCodeLsAcc-33',
        'FcElsRequestAcceptRejectFcElsRequestReserved': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsRequestReserved-34',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersFc-phVersion': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersFc-phVersion-35',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersBuffer-to-bufferCredit': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersBuffer-to-bufferCredit-36',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersCommonFeatures': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersCommonFeatures-37',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersBbScNumber': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersBbScNumber-38',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersBuffer-to-bufferReceiveDataFieldSize': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersBuffer-to-bufferReceiveDataFieldSize-39',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersRATov': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersRATov-40',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersEDTov': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersEDTov-41',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersNPortPortName': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersNPortPortName-42',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersFabricNodeName': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersFabricNodeName-43',
        'FcElsRequestAcceptRejectFcElsClass1SvcParameters': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsClass1SvcParameters-44',
        'FcElsRequestAcceptRejectFcElsClass2SvcParameters': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsClass2SvcParameters-45',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersServiceOptions': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersServiceOptions-46',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersInitiatorControl': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersInitiatorControl-47',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersRecipientControl': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersRecipientControl-48',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersClassReceiveSize': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersClassReceiveSize-49',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersTotalConcurrentSequence': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersTotalConcurrentSequence-50',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersEnd-to-endCredit': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersEnd-to-endCredit-51',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersOpenSeqPerExchange': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersOpenSeqPerExchange-52',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersCrTov': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersCrTov-53',
        'FcElsRequestAcceptRejectClass4SvcParameters': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.Class4SvcParameters-54',
        'FcElsRequestAcceptRejectFcElsVendorVersion': 'fcNpivFdicsLsAcc.header.FcEls.FcElsRequestAcceptReject.FcElsVendorVersion-55',
    }

    def __init__(self, parent, list_op=False):
        super(FcNpivFdicsLsAcc, self).__init__(parent, list_op)
    ...
    def FcElsRequestAcceptRejectFcElsRequestReserved(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FcElsRequestAcceptRejectFcElsRequestReserved']))
    ...
    def FcElsRequestAcceptRejectFcElsClass1SvcParameters(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FcElsRequestAcceptRejectFcElsClass1SvcParameters']))
    ...
    def FcElsRequestAcceptRejectFcElsClass2SvcParameters(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FcElsRequestAcceptRejectFcElsClass2SvcParameters']))
    ...
    def FcElsRequestAcceptRejectClass4SvcParameters(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FcElsRequestAcceptRejectClass4SvcParameters']))
    ...
    def FcElsRequestAcceptRejectFcElsVendorVersion(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FcElsRequestAcceptRejectFcElsVendorVersion']))
