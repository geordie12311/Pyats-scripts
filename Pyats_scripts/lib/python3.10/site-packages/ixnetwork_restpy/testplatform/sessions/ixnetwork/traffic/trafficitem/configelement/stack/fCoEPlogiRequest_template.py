...
class FCoEPlogiRequest(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEPlogiRequest'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEPlogiRequest.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEPlogiRequest.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEPlogiRequest.header.fcoeHeader.eSOF-3',
        'ExtendedLinkServicesExtendedLinkServiceInfo': 'fCoEPlogiRequest.header.fcHeader.RCtl.extendedLinkServices.extendedLinkServiceInfo-4',
        'FcHeaderDId': 'fCoEPlogiRequest.header.fcHeader.DId-5',
        'FcHeaderCsCtlPriority': 'fCoEPlogiRequest.header.fcHeader.CsCtlPriority-6',
        'FcHeaderSId': 'fCoEPlogiRequest.header.fcHeader.SId-7',
        'FcHeaderType': 'fCoEPlogiRequest.header.fcHeader.Type-8',
        'FCtlExchangeContext': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.exchangeContext-9',
        'FCtlSequenceContext': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.sequenceContext-10',
        'FCtlFirstSequence': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.firstSequence-11',
        'FCtlLastSequence': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.lastSequence-12',
        'FCtlEndSequence': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.endSequence-13',
        'FCtlEndConnection': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.endConnection-14',
        'FCtlCsCtlPriority': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.csCtlPriority-15',
        'FCtlSequenceInitiative': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.sequenceInitiative-16',
        'FCtlFcXidReassigned': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.fcXidReassigned-17',
        'FCtlFcInvalidateXid': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.fcInvalidateXid-18',
        'FCtlAckForm': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.ackForm-19',
        'FCtlFcDataCompression': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.fcDataCompression-20',
        'FCtlFcDataEncryption': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.fcDataEncryption-21',
        'FCtlRetransmittedSequence': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.retransmittedSequence-22',
        'FCtlUnidirectionalTransmit': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.unidirectionalTransmit-23',
        'FCtlContinueSeqCondition': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.continueSeqCondition-24',
        'FCtlAbortSeqCondition': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.abortSeqCondition-25',
        'FCtlRelativeOffsetPresent': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.relativeOffsetPresent-26',
        'FCtlExchangeReassembly': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.exchangeReassembly-27',
        'FCtlFillBytes': 'fCoEPlogiRequest.header.fcHeader.FCtl.fCtl.fillBytes-28',
        'FcHeaderSeqId': 'fCoEPlogiRequest.header.fcHeader.SeqId-29',
        'FcHeaderDfCtl': 'fCoEPlogiRequest.header.fcHeader.DfCtl-30',
        'FcHeaderSeqCnt': 'fCoEPlogiRequest.header.fcHeader.SeqCnt-31',
        'FcHeaderOxId': 'fCoEPlogiRequest.header.fcHeader.OxId-32',
        'FcHeaderRxId': 'fCoEPlogiRequest.header.fcHeader.RxId-33',
        'FcHeaderParameter': 'fCoEPlogiRequest.header.fcHeader.Parameter-34',
        'FcElsCommandCodeFcElsCommandCodePlogi': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsCommandCode.FcElsCommandCodePlogi-35',
        'FcElsRequestFcElsRequestReserved': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsRequestReserved-36',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersFc-phVersion': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsCommonServiceParameters.FcElsCommonServiceParametersFc-phVersion-37',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersBuffer-to-bufferCredit': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsCommonServiceParameters.FcElsCommonServiceParametersBuffer-to-bufferCredit-38',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersCommonFeatures': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsCommonServiceParameters.FcElsCommonServiceParametersCommonFeatures-39',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersBbScNumber': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsCommonServiceParameters.FcElsCommonServiceParametersBbScNumber-40',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersBuffer-to-bufferReceiveDataFieldSize': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsCommonServiceParameters.FcElsCommonServiceParametersBuffer-to-bufferReceiveDataFieldSize-41',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersRATov': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsCommonServiceParameters.FcElsCommonServiceParametersRATov-42',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersEDTov': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsCommonServiceParameters.FcElsCommonServiceParametersEDTov-43',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersNPortPortName': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsCommonServiceParameters.FcElsCommonServiceParametersNPortPortName-44',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersFabricNodeName': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsCommonServiceParameters.FcElsCommonServiceParametersFabricNodeName-45',
        'FcElsRequestFcElsClass1SvcParameters': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsClass1SvcParameters-46',
        'FcElsRequestFcElsClass2SvcParameters': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsClass2SvcParameters-47',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersServiceOptions': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsClass3SvcParameters.FcElsClass3SvcParametersServiceOptions-48',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersInitiatorControl': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsClass3SvcParameters.FcElsClass3SvcParametersInitiatorControl-49',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersRecipientControl': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsClass3SvcParameters.FcElsClass3SvcParametersRecipientControl-50',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersClassReceiveSize': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsClass3SvcParameters.FcElsClass3SvcParametersClassReceiveSize-51',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersTotalConcurrentSequence': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsClass3SvcParameters.FcElsClass3SvcParametersTotalConcurrentSequence-52',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersEnd-to-endCredit': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsClass3SvcParameters.FcElsClass3SvcParametersEnd-to-endCredit-53',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersOpenSeqPerExchange': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsClass3SvcParameters.FcElsClass3SvcParametersOpenSeqPerExchange-54',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersCrTov': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsClass3SvcParameters.FcElsClass3SvcParametersCrTov-55',
        'FcElsRequestClass4SvcParameters': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.Class4SvcParameters-56',
        'FcElsRequestFcElsVendorVersion': 'fCoEPlogiRequest.header.FcEls.FcElsRequest.FcElsVendorVersion-57',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEPlogiRequest, self).__init__(parent, list_op)
