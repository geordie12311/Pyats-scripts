...
class Ipv6Routing(Base):
    __slots__ = ()
    _SDM_NAME = 'ipv6Routing'
    _SDM_ATT_MAP = {
        'RoutingHeaderNextHeader': 'ipv6Routing.header.routingHeader.nextHeader-1',
        'RoutingHeaderHeaderExtensionLength': 'ipv6Routing.header.routingHeader.headerExtensionLength-2',
        'RoutingHeaderRoutingType': 'ipv6Routing.header.routingHeader.routingType-3',
        'RoutingHeaderSegmentsLeft': 'ipv6Routing.header.routingHeader.segmentsLeft-4',
        'RoutingHeaderRouteDataLength': 'ipv6Routing.header.routingHeader.routeDataLength-5',
        'RoutingHeaderRouteData': 'ipv6Routing.header.routingHeader.routeData-6',
        'HeaderPad': 'ipv6Routing.header.pad-7',
    }

    def __init__(self, parent, list_op=False):
        super(Ipv6Routing, self).__init__(parent, list_op)

    @property
    def RoutingHeaderNextHeader(self):
        """
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderNextHeader']))

    @property
    def RoutingHeaderHeaderExtensionLength(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderHeaderExtensionLength']))

    @property
    def RoutingHeaderRoutingType(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderRoutingType']))

    @property
    def RoutingHeaderSegmentsLeft(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderSegmentsLeft']))

    @property
    def RoutingHeaderRouteDataLength(self):
        """
        Display Name: Route data length (octets)
        Default Value: 0
        Value Format: decimal
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderRouteDataLength']))

    @property
    def RoutingHeaderRouteData(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderRouteData']))
