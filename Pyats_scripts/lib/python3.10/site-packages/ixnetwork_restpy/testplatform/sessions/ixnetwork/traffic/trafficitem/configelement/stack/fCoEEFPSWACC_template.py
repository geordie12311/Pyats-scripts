...
class FCoEEFPSWACC(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEEFPSWACC'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEEFPSWACC.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEEFPSWACC.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEEFPSWACC.header.fcoeHeader.eSOF-3',
        'FcHeaderRCTL': 'fCoEEFPSWACC.header.fcHeader.rCTL-4',
        'FcHeaderDstId': 'fCoEEFPSWACC.header.fcHeader.dstId-5',
        'FcHeaderCsCTLPriority': 'fCoEEFPSWACC.header.fcHeader.csCTLPriority-6',
        'FcHeaderSrcId': 'fCoEEFPSWACC.header.fcHeader.srcId-7',
        'FcHeaderType': 'fCoEEFPSWACC.header.fcHeader.type-8',
        'FCTLCustom': 'fCoEEFPSWACC.header.fcHeader.fCTL.custom-9',
        'BuildFCTLExchangeContext': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.exchangeContext-10',
        'BuildFCTLSequenceContext': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.sequenceContext-11',
        'BuildFCTLFirstSequence': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.firstSequence-12',
        'BuildFCTLLastSequence': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.lastSequence-13',
        'BuildFCTLEndSequence': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.endSequence-14',
        'BuildFCTLEndConnection': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.endConnection-15',
        'BuildFCTLCsCTLPriority': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.csCTLPriority-16',
        'BuildFCTLSequenceInitiative': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-17',
        'BuildFCTLFcXIDReassigned': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-18',
        'BuildFCTLFcInvalidateXID': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-19',
        'BuildFCTLAckForm': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.ackForm-20',
        'BuildFCTLFcDataCompression': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.fcDataCompression-21',
        'BuildFCTLFcDataEncryption': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-22',
        'BuildFCTLRetransmittedSequence': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-23',
        'BuildFCTLUnidirectionalTransmit': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-24',
        'BuildFCTLContinueSeqCondition': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-25',
        'BuildFCTLAbortSeqCondition': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-26',
        'BuildFCTLRelativeOffsetPresent': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-27',
        'BuildFCTLExchangeReassembly': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-28',
        'BuildFCTLFillBytes': 'fCoEEFPSWACC.header.fcHeader.fCTL.buildFCTL.fillBytes-29',
        'FcHeaderSeqID': 'fCoEEFPSWACC.header.fcHeader.seqID-30',
        'FcHeaderDfCTL': 'fCoEEFPSWACC.header.fcHeader.dfCTL-31',
        'FcHeaderSeqCNT': 'fCoEEFPSWACC.header.fcHeader.seqCNT-32',
        'FcHeaderOxID': 'fCoEEFPSWACC.header.fcHeader.oxID-33',
        'FcHeaderRxID': 'fCoEEFPSWACC.header.fcHeader.rxID-34',
        'FcHeaderParameter': 'fCoEEFPSWACC.header.fcHeader.parameter-35',
        'HeaderFcCmd': 'fCoEEFPSWACC.header.fcCmd-36',
        'HeaderReserved1': 'fCoEEFPSWACC.header.reserved1-37',
        'HeaderReserved2': 'fCoEEFPSWACC.header.reserved2-38',
        'HeaderLength': 'fCoEEFPSWACC.header.length-39',
        'HeaderReserved3': 'fCoEEFPSWACC.header.reserved3-40',
        'HeaderPrincipalSwitchPriority': 'fCoEEFPSWACC.header.principalSwitchPriority-41',
        'HeaderPrincipalSwitchName': 'fCoEEFPSWACC.header.principalSwitchName-42',
        'HeaderRecordType': 'fCoEEFPSWACC.header.recordType-43',
        'HeaderDomainID': 'fCoEEFPSWACC.header.domainID-44',
        'HeaderReserved4': 'fCoEEFPSWACC.header.reserved4-45',
        'HeaderReserved5': 'fCoEEFPSWACC.header.reserved5-46',
        'HeaderSwitchName': 'fCoEEFPSWACC.header.switchName-47',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEEFPSWACC, self).__init__(parent, list_op)
