...
class FcFlogiLsRjt(Base):
    __slots__ = ()
    _SDM_NAME = 'fcFlogiLsRjt'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fcFlogiLsRjt.header.fcHeader.sof-1',
        'ExtendedLinkServicesExtendedLinkServiceInfo': 'fcFlogiLsRjt.header.fcHeader.RCtl.extendedLinkServices.extendedLinkServiceInfo-2',
        'FcHeaderDId': 'fcFlogiLsRjt.header.fcHeader.DId-3',
        'FcHeaderCsCtlPriority': 'fcFlogiLsRjt.header.fcHeader.CsCtlPriority-4',
        'FcHeaderSId': 'fcFlogiLsRjt.header.fcHeader.SId-5',
        'FcHeaderType': 'fcFlogiLsRjt.header.fcHeader.Type-6',
        'FCtlExchangeContext': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.exchangeContext-7',
        'FCtlSequenceContext': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.sequenceContext-8',
        'FCtlFirstSequence': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.firstSequence-9',
        'FCtlLastSequence': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.lastSequence-10',
        'FCtlEndSequence': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.endSequence-11',
        'FCtlEndConnection': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.endConnection-12',
        'FCtlCsCtlPriority': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.csCtlPriority-13',
        'FCtlSequenceInitiative': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.sequenceInitiative-14',
        'FCtlFcXidReassigned': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.fcXidReassigned-15',
        'FCtlFcInvalidateXid': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.fcInvalidateXid-16',
        'FCtlAckForm': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.ackForm-17',
        'FCtlFcDataCompression': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.fcDataCompression-18',
        'FCtlFcDataEncryption': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.fcDataEncryption-19',
        'FCtlRetransmittedSequence': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.retransmittedSequence-20',
        'FCtlUnidirectionalTransmit': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.unidirectionalTransmit-21',
        'FCtlContinueSeqCondition': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.continueSeqCondition-22',
        'FCtlAbortSeqCondition': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.abortSeqCondition-23',
        'FCtlRelativeOffsetPresent': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.relativeOffsetPresent-24',
        'FCtlExchangeReassembly': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.exchangeReassembly-25',
        'FCtlFillBytes': 'fcFlogiLsRjt.header.fcHeader.FCtl.fCtl.fillBytes-26',
        'FcHeaderSeqId': 'fcFlogiLsRjt.header.fcHeader.SeqId-27',
        'FcHeaderDfCtl': 'fcFlogiLsRjt.header.fcHeader.DfCtl-28',
        'FcHeaderSeqCnt': 'fcFlogiLsRjt.header.fcHeader.SeqCnt-29',
        'FcHeaderOxId': 'fcFlogiLsRjt.header.fcHeader.OxId-30',
        'FcHeaderRxId': 'fcFlogiLsRjt.header.fcHeader.RxId-31',
        'FcHeaderParameter': 'fcFlogiLsRjt.header.fcHeader.Parameter-32',
        'FcElsCommandCodeFcElsCommandCodeLsRjt': 'fcFlogiLsRjt.header.FcEls.FcElsAcceptReject.FcElsCommandCode.FcElsCommandCodeLsRjt-33',
        'FcElsAcceptRejectFcElsAcceptRejectReserved': 'fcFlogiLsRjt.header.FcEls.FcElsAcceptReject.FcElsAcceptRejectReserved-34',
        'FcElsAcceptRejectFcElsLsRjtReasonCodes': 'fcFlogiLsRjt.header.FcEls.FcElsAcceptReject.FcElsLsRjtReasonCodes-35',
    }

    def __init__(self, parent, list_op=False):
        super(FcFlogiLsRjt, self).__init__(parent, list_op)
