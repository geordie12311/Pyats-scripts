...
class FCoEGIEL(Base):
    ...
    _SDM_NAME = 'fCoEGIEL'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGIEL.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGIEL.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGIEL.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGIEL.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGIEL.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGIEL.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGIEL.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGIEL.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGIEL.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGIEL.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGIEL.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGIEL.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGIEL.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGIEL.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGIEL.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGIEL.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGIEL.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGIEL.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGIEL.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGIEL.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGIEL.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGIEL.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGIEL.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGIEL.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGIEL.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGIEL.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGIEL.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGIEL.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGIEL.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGIEL.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoEGIEL.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoEGIEL.header.FCS.maxsize-51',
        'FCSReserved': 'fCoEGIEL.header.FCS.reserved-52',
        'FcCRCAutoCRC': 'fCoEGIEL.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCoEGIEL.header.fcCRC.generateBadCRC-54',
        'FcTrailerEEOF': 'fCoEGIEL.header.fcTrailer.eEOF-55',
        'FcTrailerReserved': 'fCoEGIEL.header.fcTrailer.reserved-56',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGIEL, self).__init__(parent, list_op)
