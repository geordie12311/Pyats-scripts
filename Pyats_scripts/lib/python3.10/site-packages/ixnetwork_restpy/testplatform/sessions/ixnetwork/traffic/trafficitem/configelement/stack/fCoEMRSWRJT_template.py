...
class FCoEMRSWRJT(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEMRSWRJT'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEMRSWRJT.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEMRSWRJT.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEMRSWRJT.header.fcoeHeader.eSOF-3',
        'FcHeaderRCTL': 'fCoEMRSWRJT.header.fcHeader.rCTL-4',
        'FcHeaderDstId': 'fCoEMRSWRJT.header.fcHeader.dstId-5',
        'FcHeaderCsCTLPriority': 'fCoEMRSWRJT.header.fcHeader.csCTLPriority-6',
        'FcHeaderSrcId': 'fCoEMRSWRJT.header.fcHeader.srcId-7',
        'FcHeaderType': 'fCoEMRSWRJT.header.fcHeader.type-8',
        'FCTLCustom': 'fCoEMRSWRJT.header.fcHeader.fCTL.custom-9',
        'BuildFCTLExchangeContext': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.exchangeContext-10',
        'BuildFCTLSequenceContext': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.sequenceContext-11',
        'BuildFCTLFirstSequence': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.firstSequence-12',
        'BuildFCTLLastSequence': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.lastSequence-13',
        'BuildFCTLEndSequence': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.endSequence-14',
        'BuildFCTLEndConnection': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.endConnection-15',
        'BuildFCTLCsCTLPriority': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-16',
        'BuildFCTLSequenceInitiative': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-17',
        'BuildFCTLFcXIDReassigned': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-18',
        'BuildFCTLFcInvalidateXID': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-19',
        'BuildFCTLAckForm': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.ackForm-20',
        'BuildFCTLFcDataCompression': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-21',
        'BuildFCTLFcDataEncryption': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-22',
        'BuildFCTLRetransmittedSequence': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-23',
        'BuildFCTLUnidirectionalTransmit': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-24',
        'BuildFCTLContinueSeqCondition': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-25',
        'BuildFCTLAbortSeqCondition': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-26',
        'BuildFCTLRelativeOffsetPresent': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-27',
        'BuildFCTLExchangeReassembly': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-28',
        'BuildFCTLFillBytes': 'fCoEMRSWRJT.header.fcHeader.fCTL.buildFCTL.fillBytes-29',
        'FcHeaderSeqID': 'fCoEMRSWRJT.header.fcHeader.seqID-30',
        'FcHeaderDfCTL': 'fCoEMRSWRJT.header.fcHeader.dfCTL-31',
        'FcHeaderSeqCNT': 'fCoEMRSWRJT.header.fcHeader.seqCNT-32',
        'FcHeaderOxID': 'fCoEMRSWRJT.header.fcHeader.oxID-33',
        'FcHeaderRxID': 'fCoEMRSWRJT.header.fcHeader.rxID-34',
        'FcHeaderParameter': 'fCoEMRSWRJT.header.fcHeader.parameter-35',
        'HeaderFcCmd': 'fCoEMRSWRJT.header.fcCmd-36',
        'HeaderReserved1': 'fCoEMRSWRJT.header.reserved1-37',
        'HeaderReserved2': 'fCoEMRSWRJT.header.reserved2-38',
        'HeaderReasonCode': 'fCoEMRSWRJT.header.reasonCode-39',
        'HeaderReasonExplain': 'fCoEMRSWRJT.header.reasonExplain-40',
        'HeaderVendor': 'fCoEMRSWRJT.header.vendor-41',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEMRSWRJT, self).__init__(parent, list_op)
