...
class ECpri(Base):
    ...
    def CommonheaderProtocolRevision(self):
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['CommonheaderProtocolRevision']))
    ...
    def CommonheaderConcatenation(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['CommonheaderConcatenation']))
    ...
    def CommonheaderMessageType(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['CommonheaderMessageType']))
    ...
    def CommonheaderPayloadSize(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['CommonheaderPayloadSize']))
