...
class FCoELSARequest(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoELSARequest'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoELSARequest.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoELSARequest.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoELSARequest.header.fcoeHeader.eSOF-3',
        'FcHeaderRCTL': 'fCoELSARequest.header.fcHeader.rCTL-4',
        'FcHeaderDstId': 'fCoELSARequest.header.fcHeader.dstId-5',
        'FcHeaderCsCTLPriority': 'fCoELSARequest.header.fcHeader.csCTLPriority-6',
        'FcHeaderSrcId': 'fCoELSARequest.header.fcHeader.srcId-7',
        'FcHeaderType': 'fCoELSARequest.header.fcHeader.type-8',
        'FCTLCustom': 'fCoELSARequest.header.fcHeader.fCTL.custom-9',
        'BuildFCTLExchangeContext': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.exchangeContext-10',
        'BuildFCTLSequenceContext': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.sequenceContext-11',
        'BuildFCTLFirstSequence': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.firstSequence-12',
        'BuildFCTLLastSequence': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.lastSequence-13',
        'BuildFCTLEndSequence': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.endSequence-14',
        'BuildFCTLEndConnection': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.endConnection-15',
        'BuildFCTLCsCTLPriority': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.csCTLPriority-16',
        'BuildFCTLSequenceInitiative': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-17',
        'BuildFCTLFcXIDReassigned': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-18',
        'BuildFCTLFcInvalidateXID': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-19',
        'BuildFCTLAckForm': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.ackForm-20',
        'BuildFCTLFcDataCompression': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.fcDataCompression-21',
        'BuildFCTLFcDataEncryption': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-22',
        'BuildFCTLRetransmittedSequence': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-23',
        'BuildFCTLUnidirectionalTransmit': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-24',
        'BuildFCTLContinueSeqCondition': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-25',
        'BuildFCTLAbortSeqCondition': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-26',
        'BuildFCTLRelativeOffsetPresent': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-27',
        'BuildFCTLExchangeReassembly': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-28',
        'BuildFCTLFillBytes': 'fCoELSARequest.header.fcHeader.fCTL.buildFCTL.fillBytes-29',
        'FcHeaderSeqID': 'fCoELSARequest.header.fcHeader.seqID-30',
        'FcHeaderDfCTL': 'fCoELSARequest.header.fcHeader.dfCTL-31',
        'FcHeaderSeqCNT': 'fCoELSARequest.header.fcHeader.seqCNT-32',
        'FcHeaderOxID': 'fCoELSARequest.header.fcHeader.oxID-33',
        'FcHeaderRxID': 'fCoELSARequest.header.fcHeader.rxID-34',
        'FcHeaderParameter': 'fCoELSARequest.header.fcHeader.parameter-35',
        'HeaderFcCmd': 'fCoELSARequest.header.fcCmd-36',
        'FspfHeaderFspfCommand': 'fCoELSARequest.header.fspfHeader.fspfCommand-37',
        'FspfHeaderFspVersion': 'fCoELSARequest.header.fspfHeader.fspVersion-38',
        'FspfHeaderFspfObsolete': 'fCoELSARequest.header.fspfHeader.fspfObsolete-39',
        'FspfHeaderFspfAuthType': 'fCoELSARequest.header.fspfHeader.fspfAuthType-40',
        'FspfHeaderFspfReserved': 'fCoELSARequest.header.fspfHeader.fspfReserved-41',
        'FspfHeaderFspfOrigDID': 'fCoELSARequest.header.fspfHeader.fspfOrigDID-42',
        'FspfHeaderFspfAuth': 'fCoELSARequest.header.fspfHeader.fspfAuth-43',
        'HeaderReserved': 'fCoELSARequest.header.reserved-44',
        'HeaderFlags': 'fCoELSARequest.header.flags-45',
        'HeaderNrLSRhs': 'fCoELSARequest.header.nrLSRhs-46',
        'LinkStateHeaderLsrType': 'fCoELSARequest.header.linkStateHeader.lsrType-47',
        'LinkStateHeaderLsrReserved1': 'fCoELSARequest.header.linkStateHeader.lsrReserved1-48',
        'LinkStateHeaderLsrAge': 'fCoELSARequest.header.linkStateHeader.lsrAge-49',
        'LinkStateHeaderLsrReserved2': 'fCoELSARequest.header.linkStateHeader.lsrReserved2-50',
        'LinkStateHeaderLsrIdentifier': 'fCoELSARequest.header.linkStateHeader.lsrIdentifier-51',
        'LinkStateHeaderLsrAdvertisingDID': 'fCoELSARequest.header.linkStateHeader.lsrAdvertisingDID-52',
        'LinkStateHeaderLsrIncarnationNr': 'fCoELSARequest.header.linkStateHeader.lsrIncarnationNr-53',
        'LinkStateHeaderLsrChecksum': 'fCoELSARequest.header.linkStateHeader.lsrChecksum-54',
        'LinkStateHeaderLsrLength': 'fCoELSARequest.header.linkStateHeader.lsrLength-55',
    }

    def __init__(self, parent, list_op=False):
        super(FCoELSARequest, self).__init__(parent, list_op)
