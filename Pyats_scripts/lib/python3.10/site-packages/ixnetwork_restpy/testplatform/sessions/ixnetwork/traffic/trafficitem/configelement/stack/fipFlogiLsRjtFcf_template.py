...
class FipFlogiLsRjtFcf(Base):
    ...
    def FipFlogiDescriptorFcElsCommandCodeFipFlogiDescriptorFcElsCommandCodeLsRjt(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FipFlogiDescriptorFcElsCommandCodeFipFlogiDescriptorFcElsCommandCodeLsRjt']))

    @property
    def FipFlogiDescriptorFcElsAcceptRejectFipFlogiDescriptorFcElsAcceptRejectReserved(self):
        """
        Display Name: Reserved
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FipFlogiDescriptorFcElsAcceptRejectFipFlogiDescriptorFcElsAcceptRejectReserved']))

    @property
    def FipFlogiDescriptorFcElsAcceptRejectFipFlogiDescriptorFcElsLsRjtReasonCodes(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FipFlogiDescriptorFcElsAcceptRejectFipFlogiDescriptorFcElsLsRjtReasonCodes']))
