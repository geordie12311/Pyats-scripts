...
class FCoERPNL(Base):
    ...
    _SDM_NAME = 'fCoERPNL'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoERPNL.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoERPNL.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoERPNL.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoERPNL.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoERPNL.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoERPNL.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoERPNL.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoERPNL.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoERPNL.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoERPNL.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoERPNL.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoERPNL.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoERPNL.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoERPNL.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoERPNL.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoERPNL.header.fcHeader.type-16',
        'FCTLCustom': 'fCoERPNL.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoERPNL.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoERPNL.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoERPNL.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoERPNL.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoERPNL.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoERPNL.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoERPNL.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoERPNL.header.fcCT.revision-44',
        'FcCTInId': 'fCoERPNL.header.fcCT.inId-45',
        'FcCTGsType': 'fCoERPNL.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoERPNL.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoERPNL.header.fcCT.options-48',
        'FcCTReserved': 'fCoERPNL.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoERPNL.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoERPNL.header.FCS.maxsize-51',
        'FCSReserved': 'fCoERPNL.header.FCS.reserved-52',
        'FCSPlatformName': 'fCoERPNL.header.FCS.platformName-53',
        'FCSPlatformNodeName': 'fCoERPNL.header.FCS.platformNodeName-54',
        'FcCRCAutoCRC': 'fCoERPNL.header.fcCRC.autoCRC-55',
        'FcCRCGenerateBadCRC': 'fCoERPNL.header.fcCRC.generateBadCRC-56',
        'FcTrailerEEOF': 'fCoERPNL.header.fcTrailer.eEOF-57',
        'FcTrailerReserved': 'fCoERPNL.header.fcTrailer.reserved-58',
    }

    def __init__(self, parent, list_op=False):
        super(FCoERPNL, self).__init__(parent, list_op)
