...
class Ipv6Authentication(Base):
    __slots__ = ()
    _SDM_NAME = 'ipv6Authentication'
    _SDM_ATT_MAP = {
        'AuthenticationHeaderNextHeader': 'ipv6Authentication.header.authenticationHeader.nextHeader-1',
        'AuthenticationHeaderPayloadLength': 'ipv6Authentication.header.authenticationHeader.payloadLength-2',
        'AuthenticationHeaderReserved': 'ipv6Authentication.header.authenticationHeader.reserved-3',
        'AuthenticationHeaderSpi': 'ipv6Authentication.header.authenticationHeader.spi-4',
        'AuthenticationHeaderSequenceNumber': 'ipv6Authentication.header.authenticationHeader.sequenceNumber-5',
        'AuthenticationSha1': 'ipv6Authentication.header.authenticationHeader.authentication.sha1-6',
        'AuthenticationMd5': 'ipv6Authentication.header.authenticationHeader.authentication.md5-7',
        'HeaderPad': 'ipv6Authentication.header.pad-8',
    }

    def __init__(self, parent, list_op=False):
        super(Ipv6Authentication, self).__init__(parent, list_op)

    @property
    def AuthenticationHeaderNextHeader(self):
        """
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AuthenticationHeaderNextHeader']))

    @property
    def AuthenticationHeaderPayloadLength(self):
        """
        Display Name: Payload Length (4 Octet)
        Default Value: 6
        Value Format: decimal
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AuthenticationHeaderPayloadLength']))

    @property
    def AuthenticationHeaderReserved(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AuthenticationHeaderReserved']))

    @property
    def AuthenticationHeaderSpi(self):
        """
        Display Name: Security Parameter Index
        Default Value: 1
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AuthenticationHeaderSpi']))

    @property
    def AuthenticationHeaderSequenceNumber(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AuthenticationHeaderSequenceNumber']))

    @property
    def AuthenticationSha1(self):
        """
        Display Name: SHA-1
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AuthenticationSha1']))

    @property
    def AuthenticationMd5(self):
        """
        Display Name: MD5
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['AuthenticationMd5']))
