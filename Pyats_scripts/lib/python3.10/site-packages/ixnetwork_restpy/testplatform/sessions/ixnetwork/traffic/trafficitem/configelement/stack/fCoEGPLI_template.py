...
class FCoEGPLI(Base):
    ...
    _SDM_NAME = 'fCoEGPLI'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGPLI.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGPLI.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGPLI.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGPLI.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGPLI.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGPLI.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGPLI.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGPLI.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGPLI.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGPLI.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGPLI.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGPLI.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGPLI.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGPLI.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGPLI.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGPLI.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGPLI.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGPLI.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGPLI.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGPLI.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGPLI.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGPLI.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGPLI.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGPLI.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGPLI.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGPLI.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGPLI.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGPLI.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGPLI.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGPLI.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoEGPLI.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoEGPLI.header.FCS.maxsize-51',
        'FCSReserved': 'fCoEGPLI.header.FCS.reserved-52',
        'FCSPlatformName': 'fCoEGPLI.header.FCS.platformName-53',
        'FcCRCAutoCRC': 'fCoEGPLI.header.fcCRC.autoCRC-54',
        'FcCRCGenerateBadCRC': 'fCoEGPLI.header.fcCRC.generateBadCRC-55',
        'FcTrailerEEOF': 'fCoEGPLI.header.fcTrailer.eEOF-56',
        'FcTrailerReserved': 'fCoEGPLI.header.fcTrailer.reserved-57',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGPLI, self).__init__(parent, list_op)
