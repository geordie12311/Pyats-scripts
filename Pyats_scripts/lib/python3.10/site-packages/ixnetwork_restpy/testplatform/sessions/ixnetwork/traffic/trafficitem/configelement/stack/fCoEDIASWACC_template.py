...
class FCoEDIASWACC(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEDIASWACC'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEDIASWACC.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEDIASWACC.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEDIASWACC.header.fcoeHeader.eSOF-3',
        'FcHeaderRCTL': 'fCoEDIASWACC.header.fcHeader.rCTL-4',
        'FcHeaderDstId': 'fCoEDIASWACC.header.fcHeader.dstId-5',
        'FcHeaderCsCTLPriority': 'fCoEDIASWACC.header.fcHeader.csCTLPriority-6',
        'FcHeaderSrcId': 'fCoEDIASWACC.header.fcHeader.srcId-7',
        'FcHeaderType': 'fCoEDIASWACC.header.fcHeader.type-8',
        'FCTLCustom': 'fCoEDIASWACC.header.fcHeader.fCTL.custom-9',
        'BuildFCTLExchangeContext': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.exchangeContext-10',
        'BuildFCTLSequenceContext': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.sequenceContext-11',
        'BuildFCTLFirstSequence': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.firstSequence-12',
        'BuildFCTLLastSequence': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.lastSequence-13',
        'BuildFCTLEndSequence': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.endSequence-14',
        'BuildFCTLEndConnection': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.endConnection-15',
        'BuildFCTLCsCTLPriority': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.csCTLPriority-16',
        'BuildFCTLSequenceInitiative': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-17',
        'BuildFCTLFcXIDReassigned': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-18',
        'BuildFCTLFcInvalidateXID': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-19',
        'BuildFCTLAckForm': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.ackForm-20',
        'BuildFCTLFcDataCompression': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.fcDataCompression-21',
        'BuildFCTLFcDataEncryption': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-22',
        'BuildFCTLRetransmittedSequence': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-23',
        'BuildFCTLUnidirectionalTransmit': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-24',
        'BuildFCTLContinueSeqCondition': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-25',
        'BuildFCTLAbortSeqCondition': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-26',
        'BuildFCTLRelativeOffsetPresent': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-27',
        'BuildFCTLExchangeReassembly': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-28',
        'BuildFCTLFillBytes': 'fCoEDIASWACC.header.fcHeader.fCTL.buildFCTL.fillBytes-29',
        'FcHeaderSeqID': 'fCoEDIASWACC.header.fcHeader.seqID-30',
        'FcHeaderDfCTL': 'fCoEDIASWACC.header.fcHeader.dfCTL-31',
        'FcHeaderSeqCNT': 'fCoEDIASWACC.header.fcHeader.seqCNT-32',
        'FcHeaderOxID': 'fCoEDIASWACC.header.fcHeader.oxID-33',
        'FcHeaderRxID': 'fCoEDIASWACC.header.fcHeader.rxID-34',
        'FcHeaderParameter': 'fCoEDIASWACC.header.fcHeader.parameter-35',
        'HeaderFcCmd': 'fCoEDIASWACC.header.fcCmd-36',
        'HeaderReserved1': 'fCoEDIASWACC.header.reserved1-37',
        'HeaderRespSwitchName': 'fCoEDIASWACC.header.respSwitchName-38',
        'HeaderReserved2': 'fCoEDIASWACC.header.reserved2-39',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEDIASWACC, self).__init__(parent, list_op)
