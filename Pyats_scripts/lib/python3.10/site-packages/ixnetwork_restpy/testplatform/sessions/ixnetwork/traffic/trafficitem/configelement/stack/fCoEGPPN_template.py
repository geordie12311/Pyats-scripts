...
class FCoEGPPN(Base):
    ...
    _SDM_NAME = 'fCoEGPPN'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGPPN.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGPPN.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGPPN.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGPPN.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGPPN.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGPPN.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGPPN.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGPPN.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGPPN.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGPPN.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGPPN.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGPPN.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGPPN.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGPPN.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGPPN.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGPPN.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGPPN.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGPPN.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGPPN.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGPPN.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGPPN.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGPPN.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGPPN.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGPPN.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGPPN.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGPPN.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGPPN.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGPPN.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGPPN.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGPPN.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoEGPPN.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoEGPPN.header.FCS.maxsize-51',
        'FCSReserved': 'fCoEGPPN.header.FCS.reserved-52',
        'FCSPortName': 'fCoEGPPN.header.FCS.portName-53',
        'FcCRCAutoCRC': 'fCoEGPPN.header.fcCRC.autoCRC-54',
        'FcCRCGenerateBadCRC': 'fCoEGPPN.header.fcCRC.generateBadCRC-55',
        'FcTrailerEEOF': 'fCoEGPPN.header.fcTrailer.eEOF-56',
        'FcTrailerReserved': 'fCoEGPPN.header.fcTrailer.reserved-57',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGPPN, self).__init__(parent, list_op)
