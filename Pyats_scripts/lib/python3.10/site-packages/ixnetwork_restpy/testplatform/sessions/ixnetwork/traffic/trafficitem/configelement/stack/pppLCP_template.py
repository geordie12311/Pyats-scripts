...
class PppLCP(Base):
    ...
    def MagicNumberNumber(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['MagicNumberNumber']))
    ...
    def RejectedProtocolId(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RejectedProtocolId']))
