...
class Ipv6RoutingType2(Base):
    __slots__ = ()
    _SDM_NAME = 'ipv6RoutingType2'
    _SDM_ATT_MAP = {
        'RoutingHeaderNextHeader': 'ipv6RoutingType2.header.routingHeader.nextHeader-1',
        'RoutingHeaderHeaderExtensionLength': 'ipv6RoutingType2.header.routingHeader.headerExtensionLength-2',
        'RoutingHeaderRoutingType': 'ipv6RoutingType2.header.routingHeader.routingType-3',
        'RoutingHeaderSegmentsLeft': 'ipv6RoutingType2.header.routingHeader.segmentsLeft-4',
        'RoutingHeaderReserved': 'ipv6RoutingType2.header.routingHeader.reserved-5',
        'RoutingHeaderHomeAddress': 'ipv6RoutingType2.header.routingHeader.homeAddress-6',
        'HeaderPad': 'ipv6RoutingType2.header.pad-7',
    }

    def __init__(self, parent, list_op=False):
        super(Ipv6RoutingType2, self).__init__(parent, list_op)
    ...
    @property
    def RoutingHeaderReserved(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderReserved']))

    @property
    def RoutingHeaderHomeAddress(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['RoutingHeaderHomeAddress']))
