...
class FCoEGATIN(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEGATIN'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGATIN.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGATIN.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGATIN.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGATIN.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGATIN.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGATIN.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGATIN.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGATIN.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGATIN.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGATIN.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGATIN.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGATIN.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGATIN.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGATIN.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGATIN.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGATIN.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGATIN.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGATIN.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGATIN.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGATIN.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGATIN.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGATIN.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGATIN.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGATIN.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGATIN.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGATIN.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGATIN.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGATIN.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGATIN.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGATIN.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoEGATIN.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoEGATIN.header.FCS.maxsize-51',
        'FCSReserved': 'fCoEGATIN.header.FCS.reserved-52',
        'FCSInterconnectElementPortName': 'fCoEGATIN.header.FCS.interconnectElementPortName-53',
        'FcCRCAutoCRC': 'fCoEGATIN.header.fcCRC.autoCRC-54',
        'FcCRCGenerateBadCRC': 'fCoEGATIN.header.fcCRC.generateBadCRC-55',
        'FcTrailerEEOF': 'fCoEGATIN.header.fcTrailer.eEOF-56',
        'FcTrailerReserved': 'fCoEGATIN.header.fcTrailer.reserved-57',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGATIN, self).__init__(parent, list_op)
