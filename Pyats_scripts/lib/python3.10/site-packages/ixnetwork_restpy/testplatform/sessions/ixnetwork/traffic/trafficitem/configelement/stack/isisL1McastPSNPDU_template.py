...
class IsisL1McastPSNPDU(Base):
    ...
    def CommonHeaderL1PduType(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['CommonHeaderL1PduType']))
    ...
    def FixedHeaderL1PSNPPduLength(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FixedHeaderL1PSNPPduLength']))
    ...
    def FixedHeaderL1PSNPSourceID(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FixedHeaderL1PSNPSourceID']))
    ...
    def ValueRemainingLifetime(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ValueRemainingLifetime']))
