...
class FCoERFFID(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoERFFID'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoERFFID.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoERFFID.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoERFFID.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoERFFID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoERFFID.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoERFFID.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoERFFID.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoERFFID.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoERFFID.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoERFFID.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoERFFID.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoERFFID.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoERFFID.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoERFFID.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoERFFID.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoERFFID.header.fcHeader.type-16',
        'FCTLCustom': 'fCoERFFID.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoERFFID.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoERFFID.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoERFFID.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoERFFID.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoERFFID.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoERFFID.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoERFFID.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoERFFID.header.fcCT.revision-44',
        'FcCTInId': 'fCoERFFID.header.fcCT.inId-45',
        'FcCTGsType': 'fCoERFFID.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoERFFID.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoERFFID.header.fcCT.options-48',
        'FcCTReserved': 'fCoERFFID.header.fcCT.reserved-49',
        'DNSOpcode': 'fCoERFFID.header.dNS.opcode-50',
        'DNSMaxsize': 'fCoERFFID.header.dNS.maxsize-51',
        'DNSReserved': 'fCoERFFID.header.dNS.reserved-52',
        'DNSReserved2': 'fCoERFFID.header.dNS.reserved2-53',
        'DNSPortId': 'fCoERFFID.header.dNS.portId-54',
        'DNSReserved': 'fCoERFFID.header.dNS.reserved-55',
        'DNSReserved2': 'fCoERFFID.header.dNS.reserved2-56',
        'DNSFc4Feature': 'fCoERFFID.header.dNS.fc4Feature-57',
        'DNSTypeCode': 'fCoERFFID.header.dNS.typeCode-58',
        'FcCRCAutoCRC': 'fCoERFFID.header.fcCRC.autoCRC-59',
        'FcCRCGenerateBadCRC': 'fCoERFFID.header.fcCRC.generateBadCRC-60',
        'FcTrailerEEOF': 'fCoERFFID.header.fcTrailer.eEOF-61',
        'FcTrailerReserved': 'fCoERFFID.header.fcTrailer.reserved-62',
    }

    def __init__(self, parent, list_op=False):
        super(FCoERFFID, self).__init__(parent, list_op)
