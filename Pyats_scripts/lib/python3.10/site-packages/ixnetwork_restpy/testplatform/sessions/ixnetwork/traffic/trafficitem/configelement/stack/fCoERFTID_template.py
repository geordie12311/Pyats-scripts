...
class FCoERFTID(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoERFTID'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoERFTID.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoERFTID.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoERFTID.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoERFTID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoERFTID.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoERFTID.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoERFTID.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoERFTID.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoERFTID.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoERFTID.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoERFTID.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoERFTID.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoERFTID.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoERFTID.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoERFTID.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoERFTID.header.fcHeader.type-16',
        'FCTLCustom': 'fCoERFTID.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoERFTID.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoERFTID.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoERFTID.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoERFTID.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoERFTID.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoERFTID.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoERFTID.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoERFTID.header.fcCT.revision-44',
        'FcCTInId': 'fCoERFTID.header.fcCT.inId-45',
        'FcCTGsType': 'fCoERFTID.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoERFTID.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoERFTID.header.fcCT.options-48',
        'FcCTReserved': 'fCoERFTID.header.fcCT.reserved-49',
        'DNSOpcode': 'fCoERFTID.header.dNS.opcode-50',
        'DNSMaxsize': 'fCoERFTID.header.dNS.maxsize-51',
        'DNSReserved': 'fCoERFTID.header.dNS.reserved-52',
        'DNSPortId': 'fCoERFTID.header.dNS.portId-53',
        'DNSFc4Types': 'fCoERFTID.header.dNS.fc4Types-54',
        'FcCRCAutoCRC': 'fCoERFTID.header.fcCRC.autoCRC-55',
        'FcCRCGenerateBadCRC': 'fCoERFTID.header.fcCRC.generateBadCRC-56',
        'FcTrailerEEOF': 'fCoERFTID.header.fcTrailer.eEOF-57',
        'FcTrailerReserved': 'fCoERFTID.header.fcTrailer.reserved-58',
    }

    def __init__(self, parent, list_op=False):
        super(FCoERFTID, self).__init__(parent, list_op)
