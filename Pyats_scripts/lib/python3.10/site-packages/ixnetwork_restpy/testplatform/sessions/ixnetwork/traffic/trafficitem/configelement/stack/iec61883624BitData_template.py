...
class Iec61883624BitData(Base):
    ...
    def GenericAM824Label1(self):
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['GenericAM824Label1']))
    ...
    def GenericAM824Audio_sample(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['GenericAM824Audio_sample']))
    ...
    def GenericAM824Label_2(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['GenericAM824Label_2']))
