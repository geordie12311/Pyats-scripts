...
class FCoEGSES(Base):
    ...
    _SDM_NAME = 'fCoEGSES'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGSES.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGSES.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGSES.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGSES.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGSES.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGSES.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGSES.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGSES.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGSES.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGSES.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGSES.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGSES.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGSES.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGSES.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGSES.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGSES.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGSES.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGSES.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGSES.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGSES.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGSES.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGSES.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGSES.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGSES.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGSES.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGSES.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGSES.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGSES.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGSES.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGSES.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoEGSES.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoEGSES.header.FCS.maxsize-51',
        'FCSReserved': 'fCoEGSES.header.FCS.reserved-52',
        'FCSInterconnectElementName': 'fCoEGSES.header.FCS.interconnectElementName-53',
        'FcCRCAutoCRC': 'fCoEGSES.header.fcCRC.autoCRC-54',
        'FcCRCGenerateBadCRC': 'fCoEGSES.header.fcCRC.generateBadCRC-55',
        'FcTrailerEEOF': 'fCoEGSES.header.fcTrailer.eEOF-56',
        'FcTrailerReserved': 'fCoEGSES.header.fcTrailer.reserved-57',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGSES, self).__init__(parent, list_op)
