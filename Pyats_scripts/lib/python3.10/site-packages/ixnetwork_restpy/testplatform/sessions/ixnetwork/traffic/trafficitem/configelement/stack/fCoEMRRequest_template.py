...
class FCoEMRRequest(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEMRRequest'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEMRRequest.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEMRRequest.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEMRRequest.header.fcoeHeader.eSOF-3',
        'FcHeaderRCTL': 'fCoEMRRequest.header.fcHeader.rCTL-4',
        'FcHeaderDstId': 'fCoEMRRequest.header.fcHeader.dstId-5',
        'FcHeaderCsCTLPriority': 'fCoEMRRequest.header.fcHeader.csCTLPriority-6',
        'FcHeaderSrcId': 'fCoEMRRequest.header.fcHeader.srcId-7',
        'FcHeaderType': 'fCoEMRRequest.header.fcHeader.type-8',
        'FCTLCustom': 'fCoEMRRequest.header.fcHeader.fCTL.custom-9',
        'BuildFCTLExchangeContext': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.exchangeContext-10',
        'BuildFCTLSequenceContext': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.sequenceContext-11',
        'BuildFCTLFirstSequence': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.firstSequence-12',
        'BuildFCTLLastSequence': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.lastSequence-13',
        'BuildFCTLEndSequence': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.endSequence-14',
        'BuildFCTLEndConnection': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.endConnection-15',
        'BuildFCTLCsCTLPriority': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.csCTLPriority-16',
        'BuildFCTLSequenceInitiative': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-17',
        'BuildFCTLFcXIDReassigned': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-18',
        'BuildFCTLFcInvalidateXID': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-19',
        'BuildFCTLAckForm': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.ackForm-20',
        'BuildFCTLFcDataCompression': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.fcDataCompression-21',
        'BuildFCTLFcDataEncryption': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-22',
        'BuildFCTLRetransmittedSequence': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-23',
        'BuildFCTLUnidirectionalTransmit': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-24',
        'BuildFCTLContinueSeqCondition': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-25',
        'BuildFCTLAbortSeqCondition': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-26',
        'BuildFCTLRelativeOffsetPresent': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-27',
        'BuildFCTLExchangeReassembly': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-28',
        'BuildFCTLFillBytes': 'fCoEMRRequest.header.fcHeader.fCTL.buildFCTL.fillBytes-29',
        'FcHeaderSeqID': 'fCoEMRRequest.header.fcHeader.seqID-30',
        'FcHeaderDfCTL': 'fCoEMRRequest.header.fcHeader.dfCTL-31',
        'FcHeaderSeqCNT': 'fCoEMRRequest.header.fcHeader.seqCNT-32',
        'FcHeaderOxID': 'fCoEMRRequest.header.fcHeader.oxID-33',
        'FcHeaderRxID': 'fCoEMRRequest.header.fcHeader.rxID-34',
        'FcHeaderParameter': 'fCoEMRRequest.header.fcHeader.parameter-35',
        'HeaderFcCmd': 'fCoEMRRequest.header.fcCmd-36',
        'HeaderReserved1': 'fCoEMRRequest.header.reserved1-37',
        'HeaderVersion': 'fCoEMRRequest.header.version-38',
        'HeaderLength': 'fCoEMRRequest.header.length-39',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEMRRequest, self).__init__(parent, list_op)
