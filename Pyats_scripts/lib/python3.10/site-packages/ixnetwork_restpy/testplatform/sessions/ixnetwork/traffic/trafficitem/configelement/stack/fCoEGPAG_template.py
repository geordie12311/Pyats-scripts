...
class FCoEGPAG(Base):
    ...
    _SDM_NAME = 'fCoEGPAG'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGPAG.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGPAG.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGPAG.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGPAG.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGPAG.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGPAG.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGPAG.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGPAG.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGPAG.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGPAG.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGPAG.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGPAG.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGPAG.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGPAG.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGPAG.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGPAG.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGPAG.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGPAG.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGPAG.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGPAG.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGPAG.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGPAG.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGPAG.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGPAG.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGPAG.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGPAG.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGPAG.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGPAG.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGPAG.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGPAG.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoEGPAG.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoEGPAG.header.FCS.maxsize-51',
        'FCSReserved': 'fCoEGPAG.header.FCS.reserved-52',
        'FCSInterconnectElementName': 'fCoEGPAG.header.FCS.interconnectElementName-53',
        'FCSNumberOfPortNames': 'fCoEGPAG.header.FCS.numberOfPortNames-54',
        'FCSPortNames': 'fCoEGPAG.header.FCS.portNames-55',
        'FcCRCAutoCRC': 'fCoEGPAG.header.fcCRC.autoCRC-56',
        'FcCRCGenerateBadCRC': 'fCoEGPAG.header.fcCRC.generateBadCRC-57',
        'FcTrailerEEOF': 'fCoEGPAG.header.fcTrailer.eEOF-58',
        'FcTrailerReserved': 'fCoEGPAG.header.fcTrailer.reserved-59',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGPAG, self).__init__(parent, list_op)
