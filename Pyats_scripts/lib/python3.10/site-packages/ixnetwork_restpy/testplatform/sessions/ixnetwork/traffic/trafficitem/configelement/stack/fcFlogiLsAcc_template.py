...
class FcFlogiLsAcc(Base):
    __slots__ = ()
    _SDM_NAME = 'fcFlogiLsAcc'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fcFlogiLsAcc.header.fcHeader.sof-1',
        'ExtendedLinkServicesExtendedLinkServiceInfo': 'fcFlogiLsAcc.header.fcHeader.RCtl.extendedLinkServices.extendedLinkServiceInfo-2',
        'FcHeaderDId': 'fcFlogiLsAcc.header.fcHeader.DId-3',
        'FcHeaderCsCtlPriority': 'fcFlogiLsAcc.header.fcHeader.CsCtlPriority-4',
        'FcHeaderSId': 'fcFlogiLsAcc.header.fcHeader.SId-5',
        'FcHeaderType': 'fcFlogiLsAcc.header.fcHeader.Type-6',
        'FCtlExchangeContext': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.exchangeContext-7',
        'FCtlSequenceContext': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.sequenceContext-8',
        'FCtlFirstSequence': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.firstSequence-9',
        'FCtlLastSequence': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.lastSequence-10',
        'FCtlEndSequence': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.endSequence-11',
        'FCtlEndConnection': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.endConnection-12',
        'FCtlCsCtlPriority': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.csCtlPriority-13',
        'FCtlSequenceInitiative': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.sequenceInitiative-14',
        'FCtlFcXidReassigned': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.fcXidReassigned-15',
        'FCtlFcInvalidateXid': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.fcInvalidateXid-16',
        'FCtlAckForm': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.ackForm-17',
        'FCtlFcDataCompression': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.fcDataCompression-18',
        'FCtlFcDataEncryption': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.fcDataEncryption-19',
        'FCtlRetransmittedSequence': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.retransmittedSequence-20',
        'FCtlUnidirectionalTransmit': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.unidirectionalTransmit-21',
        'FCtlContinueSeqCondition': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.continueSeqCondition-22',
        'FCtlAbortSeqCondition': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.abortSeqCondition-23',
        'FCtlRelativeOffsetPresent': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.relativeOffsetPresent-24',
        'FCtlExchangeReassembly': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.exchangeReassembly-25',
        'FCtlFillBytes': 'fcFlogiLsAcc.header.fcHeader.FCtl.fCtl.fillBytes-26',
        'FcHeaderSeqId': 'fcFlogiLsAcc.header.fcHeader.SeqId-27',
        'FcHeaderDfCtl': 'fcFlogiLsAcc.header.fcHeader.DfCtl-28',
        'FcHeaderSeqCnt': 'fcFlogiLsAcc.header.fcHeader.SeqCnt-29',
        'FcHeaderOxId': 'fcFlogiLsAcc.header.fcHeader.OxId-30',
        'FcHeaderRxId': 'fcFlogiLsAcc.header.fcHeader.RxId-31',
        'FcHeaderParameter': 'fcFlogiLsAcc.header.fcHeader.Parameter-32',
        'FcElsCommandCodeFcElsCommandCodeLsAcc': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsCommandCode.FcElsCommandCodeLsAcc-33',
        'FcElsAcceptRejectFcElsRequestReserved': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsRequestReserved-34',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersFc-phVersion': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersFc-phVersion-35',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersBuffer-to-bufferCredit': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersBuffer-to-bufferCredit-36',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersCommonFeatures': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersCommonFeatures-37',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersBbScNumber': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersBbScNumber-38',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersBuffer-to-bufferReceiveDataFieldSize': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersBuffer-to-bufferReceiveDataFieldSize-39',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersRATov': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersRATov-40',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersEDTov': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersEDTov-41',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersNPortPortName': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersNPortPortName-42',
        'FcElsCommonServiceParametersFcElsCommonServiceParametersFabricNodeName': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsCommonServiceParameters.FcElsCommonServiceParametersFabricNodeName-43',
        'FcElsAcceptRejectFcElsClass1SvcParameters': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsClass1SvcParameters-44',
        'FcElsAcceptRejectFcElsClass2SvcParameters': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsClass2SvcParameters-45',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersServiceOptions': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersServiceOptions-46',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersInitiatorControl': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersInitiatorControl-47',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersRecipientControl': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersRecipientControl-48',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersClassReceiveSize': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersClassReceiveSize-49',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersTotalConcurrentSequence': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersTotalConcurrentSequence-50',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersEnd-to-endCredit': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersEnd-to-endCredit-51',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersOpenSeqPerExchange': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersOpenSeqPerExchange-52',
        'FcElsClass3SvcParametersFcElsClass3SvcParametersCrTov': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsClass3SvcParameters.FcElsClass3SvcParametersCrTov-53',
        'FcElsAcceptRejectClass4SvcParameters': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.Class4SvcParameters-54',
        'FcElsAcceptRejectFcElsVendorVersion': 'fcFlogiLsAcc.header.FcEls.FcElsAcceptReject.FcElsVendorVersion-55',
    }

    def __init__(self, parent, list_op=False):
        super(FcFlogiLsAcc, self).__init__(parent, list_op)
    ...
    def FcElsAcceptRejectFcElsRequestReserved(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FcElsAcceptRejectFcElsRequestReserved']))
    ...
    def FcElsAcceptRejectFcElsClass1SvcParameters(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FcElsAcceptRejectFcElsClass1SvcParameters']))
    ...
    def FcElsAcceptRejectFcElsClass2SvcParameters(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FcElsAcceptRejectFcElsClass2SvcParameters']))
    ...
    def FcElsAcceptRejectClass4SvcParameters(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FcElsAcceptRejectClass4SvcParameters']))
    ...
    def FcElsAcceptRejectFcElsVendorVersion(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FcElsAcceptRejectFcElsVendorVersion']))
