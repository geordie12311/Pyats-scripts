...
class Ipv6Fragment(Base):
    __slots__ = ()
    _SDM_NAME = 'ipv6Fragment'
    _SDM_ATT_MAP = {
        'FragmentHeaderNextHeader': 'ipv6Fragment.fragmentHeader.nextHeader-1',
        'FragmentHeaderReserved1': 'ipv6Fragment.fragmentHeader.reserved1-2',
        'FragmentHeaderFragmentOffset': 'ipv6Fragment.fragmentHeader.fragmentOffset-3',
        'FragmentHeaderReserved2': 'ipv6Fragment.fragmentHeader.reserved2-4',
        'FragmentHeaderMoreFragments': 'ipv6Fragment.fragmentHeader.moreFragments-5',
        'FragmentHeaderIdentification': 'ipv6Fragment.fragmentHeader.identification-6',
    }

    def __init__(self, parent, list_op=False):
        super(Ipv6Fragment, self).__init__(parent, list_op)

    @property
    def FragmentHeaderNextHeader(self):
        """
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FragmentHeaderNextHeader']))

    @property
    def FragmentHeaderReserved1(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FragmentHeaderReserved1']))

    @property
    def FragmentHeaderFragmentOffset(self):
        """
        Display Name: Fragment offset (8 octets)
        Default Value: 0
        Value Format: decimal
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FragmentHeaderFragmentOffset']))

    @property
    def FragmentHeaderReserved2(self):
        """
        Display Name: Reserved
        Default Value: 0
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FragmentHeaderReserved2']))

    @property
    def FragmentHeaderMoreFragments(self):
        """
        Display Name: More Fragments
        Default Value: 0
        Value Format: decimal
        Available enum values: Last Fragment, 0, More Fragment, 1
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FragmentHeaderMoreFragments']))

    @property
    def FragmentHeaderIdentification(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FragmentHeaderIdentification']))
