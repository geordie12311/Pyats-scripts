...
class FCoEFlogiLsRjt(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEFlogiLsRjt'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEFlogiLsRjt.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEFlogiLsRjt.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEFlogiLsRjt.header.fcoeHeader.eSOF-3',
        'ExtendedLinkServicesExtendedLinkServiceInfo': 'fCoEFlogiLsRjt.header.fcHeader.RCtl.extendedLinkServices.extendedLinkServiceInfo-4',
        'FcHeaderDId': 'fCoEFlogiLsRjt.header.fcHeader.DId-5',
        'FcHeaderCsCtlPriority': 'fCoEFlogiLsRjt.header.fcHeader.CsCtlPriority-6',
        'FcHeaderSId': 'fCoEFlogiLsRjt.header.fcHeader.SId-7',
        'FcHeaderType': 'fCoEFlogiLsRjt.header.fcHeader.Type-8',
        'FCtlExchangeContext': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.exchangeContext-9',
        'FCtlSequenceContext': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.sequenceContext-10',
        'FCtlFirstSequence': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.firstSequence-11',
        'FCtlLastSequence': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.lastSequence-12',
        'FCtlEndSequence': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.endSequence-13',
        'FCtlEndConnection': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.endConnection-14',
        'FCtlCsCtlPriority': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.csCtlPriority-15',
        'FCtlSequenceInitiative': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.sequenceInitiative-16',
        'FCtlFcXidReassigned': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.fcXidReassigned-17',
        'FCtlFcInvalidateXid': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.fcInvalidateXid-18',
        'FCtlAckForm': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.ackForm-19',
        'FCtlFcDataCompression': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.fcDataCompression-20',
        'FCtlFcDataEncryption': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.fcDataEncryption-21',
        'FCtlRetransmittedSequence': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.retransmittedSequence-22',
        'FCtlUnidirectionalTransmit': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.unidirectionalTransmit-23',
        'FCtlContinueSeqCondition': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.continueSeqCondition-24',
        'FCtlAbortSeqCondition': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.abortSeqCondition-25',
        'FCtlRelativeOffsetPresent': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.relativeOffsetPresent-26',
        'FCtlExchangeReassembly': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.exchangeReassembly-27',
        'FCtlFillBytes': 'fCoEFlogiLsRjt.header.fcHeader.FCtl.fCtl.fillBytes-28',
        'FcHeaderSeqId': 'fCoEFlogiLsRjt.header.fcHeader.SeqId-29',
        'FcHeaderDfCtl': 'fCoEFlogiLsRjt.header.fcHeader.DfCtl-30',
        'FcHeaderSeqCnt': 'fCoEFlogiLsRjt.header.fcHeader.SeqCnt-31',
        'FcHeaderOxId': 'fCoEFlogiLsRjt.header.fcHeader.OxId-32',
        'FcHeaderRxId': 'fCoEFlogiLsRjt.header.fcHeader.RxId-33',
        'FcHeaderParameter': 'fCoEFlogiLsRjt.header.fcHeader.Parameter-34',
        'FcElsCommandCodeFcElsCommandCodeLsRjt': 'fCoEFlogiLsRjt.header.FcEls.FcElsAcceptReject.FcElsCommandCode.FcElsCommandCodeLsRjt-35',
        'FcElsAcceptRejectFcElsAcceptRejectReserved': 'fCoEFlogiLsRjt.header.FcEls.FcElsAcceptReject.FcElsAcceptRejectReserved-36',
        'FcElsAcceptRejectFcElsLsRjtReasonCodes': 'fCoEFlogiLsRjt.header.FcEls.FcElsAcceptReject.FcElsLsRjtReasonCodes-37',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEFlogiLsRjt, self).__init__(parent, list_op)
