...
class Ipv6GSRH(Base):
    ...
    _SDM_NAME = 'ipv6GSRH'
    _SDM_ATT_MAP = {
        'VersionTrafficClassFlowLabelVersion': 'ipv6GSRH.header.versionTrafficClassFlowLabel.version-1',
        'VersionTrafficClassFlowLabelTrafficClass': 'ipv6GSRH.header.versionTrafficClassFlowLabel.trafficClass-2',
        'VersionTrafficClassFlowLabelFlowLabel': 'ipv6GSRH.header.versionTrafficClassFlowLabel.flowLabel-3',
        'HeaderPayloadLength': 'ipv6GSRH.header.payloadLength-4',
        'HeaderNextHeader': 'ipv6GSRH.header.nextHeader-5',
        'HeaderHopLimit': 'ipv6GSRH.header.hopLimit-6',
        'HeaderSrcIP': 'ipv6GSRH.header.srcIP-7',
        'HeaderDstIP': 'ipv6GSRH.header.dstIP-8',
        'HeaderGSID': 'ipv6GSRH.header.gSID-9',
        'HeaderArgs': 'ipv6GSRH.header.args-10',
        'HeaderSi': 'ipv6GSRH.header.si-11',
    }

    def __init__(self, parent, list_op=False):
        super(Ipv6GSRH, self).__init__(parent, list_op)

    @property
    def VersionTrafficClassFlowLabelVersion(self):
        """
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['VersionTrafficClassFlowLabelVersion']))

    @property
    def VersionTrafficClassFlowLabelTrafficClass(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['VersionTrafficClassFlowLabelTrafficClass']))

    @property
    def VersionTrafficClassFlowLabelFlowLabel(self):
        """
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['VersionTrafficClassFlowLabelFlowLabel']))
    ...
    def HeaderNextHeader(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderNextHeader']))
    ...
    def HeaderHopLimit(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderHopLimit']))
    ...
    def HeaderGSID(self):
        """
        Display Name: Generalized SID
        Default Value: 0
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderGSID']))
    ...
    def HeaderArgs(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderArgs']))
    ...
    def HeaderSi(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderSi']))
