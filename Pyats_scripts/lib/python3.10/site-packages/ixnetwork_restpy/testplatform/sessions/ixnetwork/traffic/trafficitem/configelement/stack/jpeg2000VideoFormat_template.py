...
class Jpeg2000VideoFormat(Base):
    ...
    def Jpeg2000PayloadHeaderType(self):
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Jpeg2000PayloadHeaderType']))
    ...
    def Jpeg2000PayloadHeaderMainHeaderFlag(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Jpeg2000PayloadHeaderMainHeaderFlag']))
    ...
    def Jpeg2000PayloadHeaderMhId(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Jpeg2000PayloadHeaderMhId']))
    ...
    def Jpeg2000PayloadHeaderTileFieldInvalidationFlag(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Jpeg2000PayloadHeaderTileFieldInvalidationFlag']))
    ...
    def Jpeg2000PayloadHeaderPriority(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Jpeg2000PayloadHeaderPriority']))
    ...
    def Jpeg2000PayloadHeaderTileNumber(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Jpeg2000PayloadHeaderTileNumber']))
    ...
    def Jpeg2000PayloadHeaderReservedField(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Jpeg2000PayloadHeaderReservedField']))
    ...
    def Jpeg2000PayloadHeaderFragmentOffset(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Jpeg2000PayloadHeaderFragmentOffset']))
    ...
    def Jpeg2000PayloadPacketizationUnit1(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Jpeg2000PayloadPacketizationUnit1']))
    ...
    def Jpeg2000PayloadPacketizationUnit2(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['Jpeg2000PayloadPacketizationUnit2']))
