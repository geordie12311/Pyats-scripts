...
class FCoERPLM(Base):
    ...
    _SDM_NAME = 'fCoERPLM'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoERPLM.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoERPLM.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoERPLM.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoERPLM.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoERPLM.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoERPLM.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoERPLM.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoERPLM.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoERPLM.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoERPLM.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoERPLM.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoERPLM.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoERPLM.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoERPLM.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoERPLM.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoERPLM.header.fcHeader.type-16',
        'FCTLCustom': 'fCoERPLM.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoERPLM.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoERPLM.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoERPLM.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoERPLM.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoERPLM.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoERPLM.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoERPLM.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoERPLM.header.fcCT.revision-44',
        'FcCTInId': 'fCoERPLM.header.fcCT.inId-45',
        'FcCTGsType': 'fCoERPLM.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoERPLM.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoERPLM.header.fcCT.options-48',
        'FcCTReserved': 'fCoERPLM.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoERPLM.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoERPLM.header.FCS.maxsize-51',
        'FCSReserved': 'fCoERPLM.header.FCS.reserved-52',
        'FCSPlatformName': 'fCoERPLM.header.FCS.platformName-53',
        'FCSPlatformManagementAddress': 'fCoERPLM.header.FCS.platformManagementAddress-54',
        'FcCRCAutoCRC': 'fCoERPLM.header.fcCRC.autoCRC-55',
        'FcCRCGenerateBadCRC': 'fCoERPLM.header.fcCRC.generateBadCRC-56',
        'FcTrailerEEOF': 'fCoERPLM.header.fcTrailer.eEOF-57',
        'FcTrailerReserved': 'fCoERPLM.header.fcTrailer.reserved-58',
    }

    def __init__(self, parent, list_op=False):
        super(FCoERPLM, self).__init__(parent, list_op)
