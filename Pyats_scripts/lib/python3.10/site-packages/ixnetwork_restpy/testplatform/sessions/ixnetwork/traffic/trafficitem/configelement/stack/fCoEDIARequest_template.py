...
class FCoEDIARequest(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEDIARequest'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEDIARequest.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEDIARequest.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEDIARequest.header.fcoeHeader.eSOF-3',
        'FcHeaderRCTL': 'fCoEDIARequest.header.fcHeader.rCTL-4',
        'FcHeaderDstId': 'fCoEDIARequest.header.fcHeader.dstId-5',
        'FcHeaderCsCTLPriority': 'fCoEDIARequest.header.fcHeader.csCTLPriority-6',
        'FcHeaderSrcId': 'fCoEDIARequest.header.fcHeader.srcId-7',
        'FcHeaderType': 'fCoEDIARequest.header.fcHeader.type-8',
        'FCTLCustom': 'fCoEDIARequest.header.fcHeader.fCTL.custom-9',
        'BuildFCTLExchangeContext': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.exchangeContext-10',
        'BuildFCTLSequenceContext': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.sequenceContext-11',
        'BuildFCTLFirstSequence': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.firstSequence-12',
        'BuildFCTLLastSequence': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.lastSequence-13',
        'BuildFCTLEndSequence': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.endSequence-14',
        'BuildFCTLEndConnection': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.endConnection-15',
        'BuildFCTLCsCTLPriority': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.csCTLPriority-16',
        'BuildFCTLSequenceInitiative': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-17',
        'BuildFCTLFcXIDReassigned': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-18',
        'BuildFCTLFcInvalidateXID': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-19',
        'BuildFCTLAckForm': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.ackForm-20',
        'BuildFCTLFcDataCompression': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.fcDataCompression-21',
        'BuildFCTLFcDataEncryption': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-22',
        'BuildFCTLRetransmittedSequence': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-23',
        'BuildFCTLUnidirectionalTransmit': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-24',
        'BuildFCTLContinueSeqCondition': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-25',
        'BuildFCTLAbortSeqCondition': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-26',
        'BuildFCTLRelativeOffsetPresent': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-27',
        'BuildFCTLExchangeReassembly': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-28',
        'BuildFCTLFillBytes': 'fCoEDIARequest.header.fcHeader.fCTL.buildFCTL.fillBytes-29',
        'FcHeaderSeqID': 'fCoEDIARequest.header.fcHeader.seqID-30',
        'FcHeaderDfCTL': 'fCoEDIARequest.header.fcHeader.dfCTL-31',
        'FcHeaderSeqCNT': 'fCoEDIARequest.header.fcHeader.seqCNT-32',
        'FcHeaderOxID': 'fCoEDIARequest.header.fcHeader.oxID-33',
        'FcHeaderRxID': 'fCoEDIARequest.header.fcHeader.rxID-34',
        'FcHeaderParameter': 'fCoEDIARequest.header.fcHeader.parameter-35',
        'HeaderFcCmd': 'fCoEDIARequest.header.fcCmd-36',
        'HeaderReserved1': 'fCoEDIARequest.header.reserved1-37',
        'HeaderOrigSwitchName': 'fCoEDIARequest.header.origSwitchName-38',
        'HeaderReserved2': 'fCoEDIARequest.header.reserved2-39',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEDIARequest, self).__init__(parent, list_op)
