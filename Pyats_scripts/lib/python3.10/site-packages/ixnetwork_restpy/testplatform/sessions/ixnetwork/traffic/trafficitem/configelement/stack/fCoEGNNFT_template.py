...
class FCoEGNNFT(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEGNNFT'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGNNFT.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGNNFT.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGNNFT.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGNNFT.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGNNFT.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGNNFT.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGNNFT.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGNNFT.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGNNFT.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGNNFT.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGNNFT.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGNNFT.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGNNFT.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGNNFT.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGNNFT.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGNNFT.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGNNFT.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGNNFT.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGNNFT.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGNNFT.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGNNFT.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGNNFT.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGNNFT.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGNNFT.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGNNFT.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGNNFT.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGNNFT.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGNNFT.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGNNFT.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGNNFT.header.fcCT.reserved-49',
        'DNSOpcode': 'fCoEGNNFT.header.dNS.opcode-50',
        'DNSMaxsize': 'fCoEGNNFT.header.dNS.maxsize-51',
        'DNSReserved': 'fCoEGNNFT.header.dNS.reserved-52',
        'DNSFlags': 'fCoEGNNFT.header.dNS.flags-53',
        'DNSDomainIdScope': 'fCoEGNNFT.header.dNS.domainIdScope-54',
        'DNSAreaIdScope': 'fCoEGNNFT.header.dNS.areaIdScope-55',
        'DNSFc4TypeCode': 'fCoEGNNFT.header.dNS.fc4TypeCode-56',
        'FcCRCAutoCRC': 'fCoEGNNFT.header.fcCRC.autoCRC-57',
        'FcCRCGenerateBadCRC': 'fCoEGNNFT.header.fcCRC.generateBadCRC-58',
        'FcTrailerEEOF': 'fCoEGNNFT.header.fcTrailer.eEOF-59',
        'FcTrailerReserved': 'fCoEGNNFT.header.fcTrailer.reserved-60',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGNNFT, self).__init__(parent, list_op)
