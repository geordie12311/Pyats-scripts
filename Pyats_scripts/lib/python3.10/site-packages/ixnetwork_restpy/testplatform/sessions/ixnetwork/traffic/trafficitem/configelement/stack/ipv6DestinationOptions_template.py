...
class Ipv6DestinationOptions(Base):
    ...
    def DestinationOptionsHeaderNextHeader(self):
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['DestinationOptionsHeaderNextHeader']))
    ...
    def DestinationOptionsHeaderHeaderExtensionLength(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['DestinationOptionsHeaderHeaderExtensionLength']))
    ...
    def TypeAllowChange(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['TypeAllowChange']))
    ...
    def HomeAddressType(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HomeAddressType']))
    ...
    def HomeAddressLength(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HomeAddressLength']))
    ...
    def HomeAddressData(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HomeAddressData']))
