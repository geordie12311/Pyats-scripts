...
class IsisL2CSNPDU(Base):
    __slots__ = ()
    _SDM_NAME = 'isisL2CSNPDU'
    _SDM_ATT_MAP = {
        'CommonHeaderIntradomainRoutingProtocolDiscriminator': 'isisL2CSNPDU.isisHeader.commonHeader.intradomainRoutingProtocolDiscriminator-1',
        'CommonHeaderLengthIndicator': 'isisL2CSNPDU.isisHeader.commonHeader.lengthIndicator-2',
        'CommonHeaderVersionProtocolIDExtension': 'isisL2CSNPDU.isisHeader.commonHeader.versionProtocolIDExtension-3',
        'CommonHeaderIdLength': 'isisL2CSNPDU.isisHeader.commonHeader.idLength-4',
        'CommonHeaderReservedBit': 'isisL2CSNPDU.isisHeader.commonHeader.reservedBit-5',
        'CommonHeaderPduType': 'isisL2CSNPDU.isisHeader.commonHeader.pduType-6',
        'CommonHeaderVersion': 'isisL2CSNPDU.isisHeader.commonHeader.version-7',
        'CommonHeaderReserved': 'isisL2CSNPDU.isisHeader.commonHeader.reserved-8',
        'CommonHeaderMaximumAreaAddresses': 'isisL2CSNPDU.isisHeader.commonHeader.maximumAreaAddresses-9',
        'FixedHeaderPduLength': 'isisL2CSNPDU.isisHeader.fixedHeader.pduLength-10',
        'FixedHeaderSourceID': 'isisL2CSNPDU.isisHeader.fixedHeader.sourceID-11',
        'FixedHeaderStartLSPID': 'isisL2CSNPDU.isisHeader.fixedHeader.startLSPID-12',
        'FixedHeaderEndLSPID': 'isisL2CSNPDU.isisHeader.fixedHeader.endLSPID-13',
        'Tlv9LSPEntriesTlvCode': 'isisL2CSNPDU.isisHeader.tlvHeader.tlvHeaderType.tlv9LSPEntries.tlvCode-14',
        'Tlv9LSPEntriesTlvLength': 'isisL2CSNPDU.isisHeader.tlvHeader.tlvHeaderType.tlv9LSPEntries.tlvLength-15',
        'ValueFieldsRemainingLifetime': 'isisL2CSNPDU.isisHeader.tlvHeader.tlvHeaderType.tlv9LSPEntries.valueFields.remainingLifetime-16',
        'LspIDPseudonodeID': 'isisL2CSNPDU.isisHeader.tlvHeader.tlvHeaderType.tlv9LSPEntries.valueFields.lspID.pseudonodeID-17',
        'LspIDLspNumber': 'isisL2CSNPDU.isisHeader.tlvHeader.tlvHeaderType.tlv9LSPEntries.valueFields.lspID.lspNumber-18',
        'ValueFieldsSequenceNumber': 'isisL2CSNPDU.isisHeader.tlvHeader.tlvHeaderType.tlv9LSPEntries.valueFields.sequenceNumber-19',
        'ValueFieldsChecksum': 'isisL2CSNPDU.isisHeader.tlvHeader.tlvHeaderType.tlv9LSPEntries.valueFields.checksum-20',
        'Tlv10AuthenticationInformationTlvCode': 'isisL2CSNPDU.isisHeader.tlvHeader.tlvHeaderType.tlv10AuthenticationInformation.tlvCode-21',
        'Tlv10AuthenticationInformationTlvLength': 'isisL2CSNPDU.isisHeader.tlvHeader.tlvHeaderType.tlv10AuthenticationInformation.tlvLength-22',
        'ValueFieldsAuthenticationType': 'isisL2CSNPDU.isisHeader.tlvHeader.tlvHeaderType.tlv10AuthenticationInformation.valueFields.authenticationType-23',
        'ValueFieldsAuthenticationValue': 'isisL2CSNPDU.isisHeader.tlvHeader.tlvHeaderType.tlv10AuthenticationInformation.valueFields.authenticationValue-24',
    }

    def __init__(self, parent, list_op=False):
        super(IsisL2CSNPDU, self).__init__(parent, list_op)
