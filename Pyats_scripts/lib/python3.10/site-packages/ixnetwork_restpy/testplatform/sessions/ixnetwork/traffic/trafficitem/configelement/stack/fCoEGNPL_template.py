...
class FCoEGNPL(Base):
    ...
    _SDM_NAME = 'fCoEGNPL'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGNPL.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGNPL.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGNPL.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGNPL.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGNPL.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGNPL.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGNPL.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGNPL.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGNPL.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGNPL.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGNPL.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGNPL.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGNPL.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGNPL.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGNPL.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGNPL.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGNPL.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGNPL.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGNPL.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGNPL.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGNPL.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGNPL.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGNPL.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGNPL.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGNPL.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGNPL.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGNPL.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGNPL.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGNPL.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGNPL.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoEGNPL.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoEGNPL.header.FCS.maxsize-51',
        'FCSReserved': 'fCoEGNPL.header.FCS.reserved-52',
        'FcCRCAutoCRC': 'fCoEGNPL.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCoEGNPL.header.fcCRC.generateBadCRC-54',
        'FcTrailerEEOF': 'fCoEGNPL.header.fcTrailer.eEOF-55',
        'FcTrailerReserved': 'fCoEGNPL.header.fcTrailer.reserved-56',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGNPL, self).__init__(parent, list_op)
