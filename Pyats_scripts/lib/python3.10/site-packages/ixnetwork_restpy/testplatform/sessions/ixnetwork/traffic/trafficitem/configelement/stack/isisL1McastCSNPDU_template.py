...
class IsisL1McastCSNPDU(Base):
    ...
    def CommonHeaderL1PduTypeL1CSNP(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['CommonHeaderL1PduTypeL1CSNP']))
    ...
    def FixedHeaderL1CSNPPduLength(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FixedHeaderL1CSNPPduLength']))
    ...
    def FixedHeaderL1CSNPSourceID(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FixedHeaderL1CSNPSourceID']))
    ...
    def FixedHeaderL1CSNPStartLSPID(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FixedHeaderL1CSNPStartLSPID']))
    ...
    def FixedHeaderL1CSNPEndLSPID(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FixedHeaderL1CSNPEndLSPID']))
    ...
    def ValueRemainingLlifetime(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ValueRemainingLlifetime']))
    ...
    def ValueSequenceNumber(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['ValueSequenceNumber']))
