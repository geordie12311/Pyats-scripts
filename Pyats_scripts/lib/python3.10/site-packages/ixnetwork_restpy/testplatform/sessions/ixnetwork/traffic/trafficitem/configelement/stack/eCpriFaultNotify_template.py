...
class ECpriFaultNotify(Base):
    ...
    def HeaderElementId(self):
        ...
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderElementId']))
    ...
    def HeaderRaiseCease(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderRaiseCease']))
    ...
    def HeaderFaultNotifNum(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderFaultNotifNum']))
