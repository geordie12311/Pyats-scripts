...
class FipFlogiRequestEnode(Base):
    ...
    def FipFlogiDescriptorFcElsCommandCodeFipFlogiDescriptorFcElsCommandCodeFlogi(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FipFlogiDescriptorFcElsCommandCodeFipFlogiDescriptorFcElsCommandCodeFlogi']))
    ...
    def FipFlogiDescriptorFcElsRequestFipFlogiDescriptorFcElsRequestReserved(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FipFlogiDescriptorFcElsRequestFipFlogiDescriptorFcElsRequestReserved']))
    ...
    def FipFlogiDescriptorFcElsRequestFipFlogiDescriptorFcElsClass1SvcParameters(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FipFlogiDescriptorFcElsRequestFipFlogiDescriptorFcElsClass1SvcParameters']))
    ...
    def FipFlogiDescriptorFcElsRequestFipFlogiDescriptorFcElsClass2SvcParameters(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FipFlogiDescriptorFcElsRequestFipFlogiDescriptorFcElsClass2SvcParameters']))
    ...
    def FipFlogiDescriptorFcElsRequestFipFlogiDescriptorClass4SvcParameters(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FipFlogiDescriptorFcElsRequestFipFlogiDescriptorClass4SvcParameters']))
    ...
    def FipFlogiDescriptorFcElsRequestFipFlogiDescriptorFcElsVendorVersion(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FipFlogiDescriptorFcElsRequestFipFlogiDescriptorFcElsVendorVersion']))
