...
class FCoEGPT(Base):
    ...
    _SDM_NAME = 'fCoEGPT'
    _SDM_ATT_MAP = {
        'FcoeHeaderVersion': 'fCoEGPT.header.fcoeHeader.version-1',
        'FcoeHeaderReserved': 'fCoEGPT.header.fcoeHeader.reserved-2',
        'FcoeHeaderESOF': 'fCoEGPT.header.fcoeHeader.eSOF-3',
        'DeviceDataFramesDeviceDataInfo': 'fCoEGPT.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-4',
        'RCTLReserved': 'fCoEGPT.header.fcHeader.rCTL.reserved-5',
        'ExtendedLinkServicesInfo': 'fCoEGPT.header.fcHeader.rCTL.extendedLinkServices.info-6',
        'Fc4LinkDataInfo': 'fCoEGPT.header.fcHeader.rCTL.fc4LinkData.info-7',
        'VideoDataInfo': 'fCoEGPT.header.fcHeader.rCTL.videoData.info-8',
        'ExtendedHeaderInfo': 'fCoEGPT.header.fcHeader.rCTL.extendedHeader.info-9',
        'BasicLinkServicesInfo': 'fCoEGPT.header.fcHeader.rCTL.basicLinkServices.info-10',
        'LinkControlFramesInfo': 'fCoEGPT.header.fcHeader.rCTL.linkControlFrames.info-11',
        'ExtendedRoutingInfo': 'fCoEGPT.header.fcHeader.rCTL.extendedRouting.info-12',
        'FcHeaderDstId': 'fCoEGPT.header.fcHeader.dstId-13',
        'FcHeaderCsCTLPriority': 'fCoEGPT.header.fcHeader.csCTLPriority-14',
        'FcHeaderSrcId': 'fCoEGPT.header.fcHeader.srcId-15',
        'FcHeaderType': 'fCoEGPT.header.fcHeader.type-16',
        'FCTLCustom': 'fCoEGPT.header.fcHeader.fCTL.custom-17',
        'BuildFCTLExchangeContext': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.exchangeContext-18',
        'BuildFCTLSequenceContext': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.sequenceContext-19',
        'BuildFCTLFirstSequence': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.firstSequence-20',
        'BuildFCTLLastSequence': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.lastSequence-21',
        'BuildFCTLEndSequence': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.endSequence-22',
        'BuildFCTLEndConnection': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.endConnection-23',
        'BuildFCTLCsCTLPriority': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-24',
        'BuildFCTLSequenceInitiative': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-25',
        'BuildFCTLFcXIDReassigned': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-26',
        'BuildFCTLFcInvalidateXID': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-27',
        'BuildFCTLAckForm': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.ackForm-28',
        'BuildFCTLFcDataCompression': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-29',
        'BuildFCTLFcDataEncryption': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-30',
        'BuildFCTLRetransmittedSequence': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-31',
        'BuildFCTLUnidirectionalTransmit': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-32',
        'BuildFCTLContinueSeqCondition': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-33',
        'BuildFCTLAbortSeqCondition': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-34',
        'BuildFCTLRelativeOffsetPresent': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-35',
        'BuildFCTLExchangeReassembly': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-36',
        'BuildFCTLFillBytes': 'fCoEGPT.header.fcHeader.fCTL.buildFCTL.fillBytes-37',
        'FcHeaderSeqID': 'fCoEGPT.header.fcHeader.seqID-38',
        'FcHeaderDfCTL': 'fCoEGPT.header.fcHeader.dfCTL-39',
        'FcHeaderSeqCNT': 'fCoEGPT.header.fcHeader.seqCNT-40',
        'FcHeaderOxID': 'fCoEGPT.header.fcHeader.oxID-41',
        'FcHeaderRxID': 'fCoEGPT.header.fcHeader.rxID-42',
        'FcHeaderParameter': 'fCoEGPT.header.fcHeader.parameter-43',
        'FcCTRevision': 'fCoEGPT.header.fcCT.revision-44',
        'FcCTInId': 'fCoEGPT.header.fcCT.inId-45',
        'FcCTGsType': 'fCoEGPT.header.fcCT.gsType-46',
        'FcCTGsSubtype': 'fCoEGPT.header.fcCT.gsSubtype-47',
        'FcCTOptions': 'fCoEGPT.header.fcCT.options-48',
        'FcCTReserved': 'fCoEGPT.header.fcCT.reserved-49',
        'FCSOpcode': 'fCoEGPT.header.FCS.opcode-50',
        'FCSMaxsize': 'fCoEGPT.header.FCS.maxsize-51',
        'FCSReserved': 'fCoEGPT.header.FCS.reserved-52',
        'FCSPortName': 'fCoEGPT.header.FCS.portName-53',
        'FcCRCAutoCRC': 'fCoEGPT.header.fcCRC.autoCRC-54',
        'FcCRCGenerateBadCRC': 'fCoEGPT.header.fcCRC.generateBadCRC-55',
        'FcTrailerEEOF': 'fCoEGPT.header.fcTrailer.eEOF-56',
        'FcTrailerReserved': 'fCoEGPT.header.fcTrailer.reserved-57',
    }

    def __init__(self, parent, list_op=False):
        super(FCoEGPT, self).__init__(parent, list_op)
